...
const (
	...
	SwitchAttr_SWITCH_ATTR_ARS_PROFILE                                            SwitchAttr = 212
	SwitchAttr_SWITCH_ATTR_ACL_STAGE_POST_INGRESS                                 SwitchAttr = 213
	SwitchAttr_SWITCH_ATTR_CREDIT_WD                                              SwitchAttr = 214
	SwitchAttr_SWITCH_ATTR_CREDIT_WD_TIMER                                        SwitchAttr = 215
	SwitchAttr_SWITCH_ATTR_SWITCH_ISOLATE                                         SwitchAttr = 216
	SwitchAttr_SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE                         SwitchAttr = 217
	SwitchAttr_SWITCH_ATTR_SWITCH_ASIC_SDK_HEALTH_EVENT_NOTIFY                    SwitchAttr = 218
	SwitchAttr_SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY              SwitchAttr = 219
	SwitchAttr_SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY            SwitchAttr = 220
	SwitchAttr_SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY             SwitchAttr = 221
	SwitchAttr_SWITCH_ATTR_ACL_CHAIN_LIST                                         SwitchAttr = 222
	SwitchAttr_SWITCH_ATTR_PORT_HOST_TX_READY_NOTIFY                              SwitchAttr = 223
	SwitchAttr_SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MINIMUM_PRIORITY               SwitchAttr = 224
	SwitchAttr_SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MAXIMUM_PRIORITY               SwitchAttr = 225
	SwitchAttr_SWITCH_ATTR_TWAMP_SESSION_EVENT_NOTIFY                             SwitchAttr = 226
	SwitchAttr_SWITCH_ATTR_AVAILABLE_TWAMP_SESSION                                SwitchAttr = 227
	SwitchAttr_SWITCH_ATTR_MAX_TWAMP_SESSION                                      SwitchAttr = 228
	SwitchAttr_SWITCH_ATTR_AVAILABLE_IP_NEXT_HOP_GROUP_MEMBER_ENTRY               SwitchAttr = 229
	SwitchAttr_SWITCH_ATTR_AVAILABLE_SYSTEM_VOQS                                  SwitchAttr = 230
	SwitchAttr_SWITCH_ATTR_ACL_STAGE_PRE_INGRESS                                  SwitchAttr = 231
	SwitchAttr_SWITCH_ATTR_POE_DEVICE_LIST                                        SwitchAttr = 232
	SwitchAttr_SWITCH_ATTR_ICMP_ECHO_SESSION_STATE_CHANGE_NOTIFY                  SwitchAttr = 233
	SwitchAttr_SWITCH_ATTR_AVAILABLE_ICMP_ECHO_SESSION                            SwitchAttr = 234
	...
	SwitchAttr_SWITCH_ATTR_DISABLE_VLAN_CHECKS                                    SwitchAttr = 238
	SwitchAttr_SWITCH_ATTR_DISABLE_INGRESS_VLAN_CHECKS                            SwitchAttr = 239
	SwitchAttr_SWITCH_ATTR_DISABLE_EGRESS_VLAN_CHECKS                             SwitchAttr = 240
)
...
var (
	SwitchAttr_name = map[int32]string{
		...
		212: "SWITCH_ATTR_ARS_PROFILE",
		213: "SWITCH_ATTR_ACL_STAGE_POST_INGRESS",
		214: "SWITCH_ATTR_CREDIT_WD",
		215: "SWITCH_ATTR_CREDIT_WD_TIMER",
		216: "SWITCH_ATTR_SWITCH_ISOLATE",
		217: "SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE",
		218: "SWITCH_ATTR_SWITCH_ASIC_SDK_HEALTH_EVENT_NOTIFY",
		219: "SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY",
		220: "SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY",
		221: "SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY",
		222: "SWITCH_ATTR_ACL_CHAIN_LIST",
		223: "SWITCH_ATTR_PORT_HOST_TX_READY_NOTIFY",
		224: "SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MINIMUM_PRIORITY",
		225: "SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MAXIMUM_PRIORITY",
		226: "SWITCH_ATTR_TWAMP_SESSION_EVENT_NOTIFY",
		227: "SWITCH_ATTR_AVAILABLE_TWAMP_SESSION",
		228: "SWITCH_ATTR_MAX_TWAMP_SESSION",
		229: "SWITCH_ATTR_AVAILABLE_IP_NEXT_HOP_GROUP_MEMBER_ENTRY",
		230: "SWITCH_ATTR_AVAILABLE_SYSTEM_VOQS",
		231: "SWITCH_ATTR_ACL_STAGE_PRE_INGRESS",
		232: "SWITCH_ATTR_POE_DEVICE_LIST",
		233: "SWITCH_ATTR_ICMP_ECHO_SESSION_STATE_CHANGE_NOTIFY",
		234: "SWITCH_ATTR_AVAILABLE_ICMP_ECHO_SESSION",
		235: "SWITCH_ATTR_MAX_ICMP_ECHO_SESSION",
		236: "SWITCH_ATTR_STATS_COUNT_MODE",
		237: "SWITCH_ATTR_SELECTIVE_COUNTER_LIST",
		238: "SWITCH_ATTR_DISABLE_VLAN_CHECKS",
		239: "SWITCH_ATTR_DISABLE_INGRESS_VLAN_CHECKS",
		240: "SWITCH_ATTR_DISABLE_EGRESS_VLAN_CHECKS",
	}
	SwitchAttr_value = map[string]int32{
		...
		"SWITCH_ATTR_ICMP_ECHO_SESSION_STATE_CHANGE_NOTIFY":                  233,
		"SWITCH_ATTR_AVAILABLE_ICMP_ECHO_SESSION":                            234,
		"SWITCH_ATTR_MAX_ICMP_ECHO_SESSION":                                  235,
		"SWITCH_ATTR_STATS_COUNT_MODE":                                       236,
		"SWITCH_ATTR_SELECTIVE_COUNTER_LIST":                                 237,
		"SWITCH_ATTR_DISABLE_VLAN_CHECKS":                                    238,
		"SWITCH_ATTR_DISABLE_INGRESS_VLAN_CHECKS":                            239,
		"SWITCH_ATTR_DISABLE_EGRESS_VLAN_CHECKS":                             240,
	}
)
...
type CreateSwitchRequest struct {
	...
	ArsProfile                            *uint64                           `protobuf:"varint,84,opt,name=ars_profile,json=arsProfile,proto3,oneof" json:"ars_profile,omitempty"`
	CreditWd                              *bool                             `protobuf:"varint,85,opt,name=credit_wd,json=creditWd,proto3,oneof" json:"credit_wd,omitempty"`
	CreditWdTimer                         *uint32                           `protobuf:"varint,86,opt,name=credit_wd_timer,json=creditWdTimer,proto3,oneof" json:"credit_wd_timer,omitempty"`
	SwitchIsolate                         *bool                             `protobuf:"varint,87,opt,name=switch_isolate,json=switchIsolate,proto3,oneof" json:"switch_isolate,omitempty"`
	HostifOperStatusUpdateMode            *SwitchHostifOperStatusUpdateMode `protobuf:"varint,88,opt,name=hostif_oper_status_update_mode,json=hostifOperStatusUpdateMode,proto3,enum=lemming.dataplane.sai.SwitchHostifOperStatusUpdateMode,oneof" json:"hostif_oper_status_update_mode,omitempty"`
	RegFatalSwitchAsicSdkHealthCategory   []SwitchAsicSdkHealthCategory     `protobuf:"varint,89,rep,packed,name=reg_fatal_switch_asic_sdk_health_category,json=regFatalSwitchAsicSdkHealthCategory,proto3,enum=lemming.dataplane.sai.SwitchAsicSdkHealthCategory" json:"reg_fatal_switch_asic_sdk_health_category,omitempty"`
	RegWarningSwitchAsicSdkHealthCategory []SwitchAsicSdkHealthCategory     `protobuf:"varint,90,rep,packed,name=reg_warning_switch_asic_sdk_health_category,json=regWarningSwitchAsicSdkHealthCategory,proto3,enum=lemming.dataplane.sai.SwitchAsicSdkHealthCategory" json:"reg_warning_switch_asic_sdk_health_category,omitempty"`
	RegNoticeSwitchAsicSdkHealthCategory  []SwitchAsicSdkHealthCategory     `protobuf:"varint,91,rep,packed,name=reg_notice_switch_asic_sdk_health_category,json=regNoticeSwitchAsicSdkHealthCategory,proto3,enum=lemming.dataplane.sai.SwitchAsicSdkHealthCategory" json:"reg_notice_switch_asic_sdk_health_category,omitempty"`
...
func (x *CreateSwitchRequest) GetArsProfile() uint64 {
	if x != nil && x.ArsProfile != nil {
		return *x.ArsProfile
	}
	return 0
}

func (x *CreateSwitchRequest) GetCreditWd() bool {
	if x != nil && x.CreditWd != nil {
		return *x.CreditWd
	}
	return false
}

func (x *CreateSwitchRequest) GetCreditWdTimer() uint32 {
	if x != nil && x.CreditWdTimer != nil {
		return *x.CreditWdTimer
	}
	return 0
}

func (x *CreateSwitchRequest) GetSwitchIsolate() bool {
	if x != nil && x.SwitchIsolate != nil {
		return *x.SwitchIsolate
	}
	return false
}

func (x *CreateSwitchRequest) GetHostifOperStatusUpdateMode() SwitchHostifOperStatusUpdateMode {
	if x != nil && x.HostifOperStatusUpdateMode != nil {
		return *x.HostifOperStatusUpdateMode
	}
	return SwitchHostifOperStatusUpdateMode_SWITCH_HOSTIF_OPER_STATUS_UPDATE_MODE_UNSPECIFIED
}

func (x *CreateSwitchRequest) GetRegFatalSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegFatalSwitchAsicSdkHealthCategory
	}
	return nil
}

func (x *CreateSwitchRequest) GetRegWarningSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegWarningSwitchAsicSdkHealthCategory
	}
	return nil
}

func (x *CreateSwitchRequest) GetRegNoticeSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegNoticeSwitchAsicSdkHealthCategory
	}
	return nil
}

func (x *CreateSwitchRequest) GetPoeDeviceList() []uint64 {
	if x != nil {
		return x.PoeDeviceList
	}
	return nil
}

func (x *CreateSwitchRequest) GetStatsCountMode() StatsCountMode {
...
func (x *CreateSwitchRequest) GetSelectiveCounterList() []uint64 {
	if x != nil {
...
type SetSwitchAttributeRequest struct {
	...
	ArsProfile                            *uint64                           `protobuf:"varint,71,opt,name=ars_profile,json=arsProfile,proto3,oneof" json:"ars_profile,omitempty"`
	CreditWd                              *bool                             `protobuf:"varint,72,opt,name=credit_wd,json=creditWd,proto3,oneof" json:"credit_wd,omitempty"`
	CreditWdTimer                         *uint32                           `protobuf:"varint,73,opt,name=credit_wd_timer,json=creditWdTimer,proto3,oneof" json:"credit_wd_timer,omitempty"`
	SwitchIsolate                         *bool                             `protobuf:"varint,74,opt,name=switch_isolate,json=switchIsolate,proto3,oneof" json:"switch_isolate,omitempty"`
	HostifOperStatusUpdateMode            *SwitchHostifOperStatusUpdateMode `protobuf:"varint,75,opt,name=hostif_oper_status_update_mode,json=hostifOperStatusUpdateMode,proto3,enum=lemming.dataplane.sai.SwitchHostifOperStatusUpdateMode,oneof" json:"hostif_oper_status_update_mode,omitempty"`
	RegFatalSwitchAsicSdkHealthCategory   []SwitchAsicSdkHealthCategory     `protobuf:"varint,76,rep,packed,name=reg_fatal_switch_asic_sdk_health_category,json=regFatalSwitchAsicSdkHealthCategory,proto3,enum=lemming.dataplane.sai.SwitchAsicSdkHealthCategory" json:"reg_fatal_switch_asic_sdk_health_category,omitempty"`
	RegWarningSwitchAsicSdkHealthCategory []SwitchAsicSdkHealthCategory     `protobuf:"varint,77,rep,packed,name=reg_warning_switch_asic_sdk_health_category,json=regWarningSwitchAsicSdkHealthCategory,proto3,enum=lemming.dataplane.sai.SwitchAsicSdkHealthCategory" json:"reg_warning_switch_asic_sdk_health_category,omitempty"`
	...
	DisableVlanChecks                     *bool                             `protobuf:"varint,82,opt,name=disable_vlan_checks,json=disableVlanChecks,proto3,oneof" json:"disable_vlan_checks,omitempty"`
	DisableIngressVlanChecks              *bool                             `protobuf:"varint,83,opt,name=disable_ingress_vlan_checks,json=disableIngressVlanChecks,proto3,oneof" json:"disable_ingress_vlan_checks,omitempty"`
	DisableEgressVlanChecks               *bool                             `protobuf:"varint,84,opt,name=disable_egress_vlan_checks,json=disableEgressVlanChecks,proto3,oneof" json:"disable_egress_vlan_checks,omitempty"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
func (x *SetSwitchAttributeRequest) GetArsProfile() uint64 {
	if x != nil && x.ArsProfile != nil {
		return *x.ArsProfile
	}
	return 0
...
func (x *SetSwitchAttributeRequest) GetCreditWd() bool {
	if x != nil && x.CreditWd != nil {
		return *x.CreditWd
	}
	return false
...
func (x *SetSwitchAttributeRequest) GetCreditWdTimer() uint32 {
	if x != nil && x.CreditWdTimer != nil {
		return *x.CreditWdTimer
	}
	return 0
...
func (x *SetSwitchAttributeRequest) GetSwitchIsolate() bool {
	if x != nil && x.SwitchIsolate != nil {
		return *x.SwitchIsolate
	}
	return false
...
func (x *SetSwitchAttributeRequest) GetHostifOperStatusUpdateMode() SwitchHostifOperStatusUpdateMode {
	if x != nil && x.HostifOperStatusUpdateMode != nil {
		return *x.HostifOperStatusUpdateMode
	}
	return SwitchHostifOperStatusUpdateMode_SWITCH_HOSTIF_OPER_STATUS_UPDATE_MODE_UNSPECIFIED
...
func (x *SetSwitchAttributeRequest) GetRegFatalSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegFatalSwitchAsicSdkHealthCategory
	}
	return nil
...
func (x *SetSwitchAttributeRequest) GetRegWarningSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegWarningSwitchAsicSdkHealthCategory
	}
	return nil
...
func (x *SetSwitchAttributeRequest) GetRegNoticeSwitchAsicSdkHealthCategory() []SwitchAsicSdkHealthCategory {
	if x != nil {
		return x.RegNoticeSwitchAsicSdkHealthCategory
	}
	return nil
...
func (x *SetSwitchAttributeRequest) GetPoeDeviceList() []uint64 {
	if x != nil {
		return x.PoeDeviceList
	}
	return nil
...
func (x *SetSwitchAttributeRequest) GetStatsCountMode() StatsCountMode {
	if x != nil && x.StatsCountMode != nil {
		return *x.StatsCountMode
	}
	return StatsCountMode_STATS_COUNT_MODE_UNSPECIFIED
...
func (x *SetSwitchAttributeRequest) GetSelectiveCounterList() []uint64 {
	if x != nil {
		return x.SelectiveCounterList
	}
	return nil
...
func (x *SetSwitchAttributeRequest) GetDisableVlanChecks() bool {
...
const file_dataplane_proto_sai_switch_proto_rawDesc = "" +
	...
	"\n" +
	"egress_acl\x18\x02 \x01(\x04B\x06\xf0ܓ\xad\x0f,H\x01R\tegressAcl\x88\x01\x01\x12.\n" +
	"\frestart_warm\x18\x03 \x01(\bB\x06\xf0ܓ\xad\x0fHH\x02R\vrestartWarm\x88\x01\x01\x12.\n" +
	"\fwarm_recover\x18\x04 \x01(\bB\x06\xf0ܓ\xad\x0fIH\x03R\vwarmRecover\x88\x01\x01\x12^\n" +
	"\x0eswitching_mode\x18\x05 \x01(\x0e2*.lemming.dataplane.sai.SwitchSwitchingModeB\x06\xf0ܓ\xad\x0fQH\x04R\rswitchingMode\x88\x01\x01\x12@\n" +
	"\x16bcast_cpu_flood_enable\x18\x06 \x01(\bB\x06\xf0ܓ\xad\x0fRH\x05R\x13bcastCpuFloodEnable\x88\x01\x01\x12@\n" +
	"\x16mcast_cpu_flood_enable\x18\a \x01(\bB\x06\xf0ܓ\xad\x0fSH\x06R\x13mcastCpuFloodEnable\x88\x01\x01\x123\n" +
	"\x0fsrc_mac_address\x18\b \x01(\fB\x06\xf0ܓ\xad\x0fTH\aR\rsrcMacAddress\x88\x01\x01\x12?\n" +
	"\x15max_learned_addresses\x18\t \x01(\rB\x06\xf0ܓ\xad\x0fUH\bR\x13maxLearnedAddresses\x88\x01\x01\x121\n" +
	"\x0efdb_aging_time\x18\n" +
	" \x01(\rB\x06\xf0ܓ\xad\x0fVH\tR\ffdbAgingTime\x88\x01\x01\x12t\n" +
	"\x1efdb_unicast_miss_packet_action\x18\v \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fWH\n" +
	"R\x1afdbUnicastMissPacketAction\x88\x01\x01\x12x\n" +
	" fdb_broadcast_miss_packet_action\x18\f \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fXH\vR\x1cfdbBroadcastMissPacketAction\x88\x01\x01\x12x\n" +
	" fdb_multicast_miss_packet_action\x18\r \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fYH\fR\x1cfdbMulticastMissPacketAction\x88\x01\x01\x12p\n" +
	"\x1becmp_default_hash_algorithm\x18\x0e \x01(\x0e2$.lemming.dataplane.sai.HashAlgorithmB\x06\xf0ܓ\xad\x0fZH\rR\x18ecmpDefaultHashAlgorithm\x88\x01\x01\x12@\n" +
	"\x16ecmp_default_hash_seed\x18\x0f \x01(\rB\x06\xf0ܓ\xad\x0f[H\x0eR\x13ecmpDefaultHashSeed\x88\x01\x01\x12D\n" +
	"\x18ecmp_default_hash_offset\x18\x10 \x01(\rB\x06\xf0ܓ\xad\x0f\\H\x0fR\x15ecmpDefaultHashOffset\x88\x01\x01\x12J\n" +
	"\x1becmp_default_symmetric_hash\x18\x11 \x01(\bB\x06\xf0ܓ\xad\x0f]H\x10R\x18ecmpDefaultSymmetricHash\x88\x01\x01\x121\n" +
	"\x0eecmp_hash_ipv4\x18\x12 \x01(\x04B\x06\xf0ܓ\xad\x0f^H\x11R\fecmpHashIpv4\x88\x01\x01\x12?\n" +
	"\x16ecmp_hash_ipv4_in_ipv4\x18\x13 \x01(\x04B\x06\xf0ܓ\xad\x0f_H\x12R\x12ecmpHashIpv4InIpv4\x88\x01\x01\x121\n" +
	"\x0eecmp_hash_ipv6\x18\x14 \x01(\x04B\x06\xf0ܓ\xad\x0f`H\x13R\fecmpHashIpv6\x88\x01\x01\x12n\n" +
	"\x1alag_default_hash_algorithm\x18\x15 \x01(\x0e2$.lemming.dataplane.sai.HashAlgorithmB\x06\xf0ܓ\xad\x0faH\x14R\x17lagDefaultHashAlgorithm\x88\x01\x01\x12>\n" +
	"\x15lag_default_hash_seed\x18\x16 \x01(\rB\x06\xf0ܓ\xad\x0fbH\x15R\x12lagDefaultHashSeed\x88\x01\x01\x12B\n" +
	"\x17lag_default_hash_offset\x18\x17 \x01(\rB\x06\xf0ܓ\xad\x0fcH\x16R\x14lagDefaultHashOffset\x88\x01\x01\x12H\n" +
	"\x1alag_default_symmetric_hash\x18\x18 \x01(\bB\x06\xf0ܓ\xad\x0fdH\x17R\x17lagDefaultSymmetricHash\x88\x01\x01\x12/\n" +
	"\rlag_hash_ipv4\x18\x19 \x01(\x04B\x06\xf0ܓ\xad\x0feH\x18R\vlagHashIpv4\x88\x01\x01\x12=\n" +
	"\x15lag_hash_ipv4_in_ipv4\x18\x1a \x01(\x04B\x06\xf0ܓ\xad\x0ffH\x19R\x11lagHashIpv4InIpv4\x88\x01\x01\x12/\n" +
	"\rlag_hash_ipv6\x18\x1b \x01(\x04B\x06\xf0ܓ\xad\x0fgH\x1aR\vlagHashIpv6\x88\x01\x01\x12E\n" +
	"\x18counter_refresh_interval\x18\x1c \x01(\rB\x06\xf0ܓ\xad\x0fhH\x1bR\x16counterRefreshInterval\x88\x01\x01\x121\n" +
	"\x0eqos_default_tc\x18\x1d \x01(\rB\x06\xf0ܓ\xad\x0fiH\x1cR\fqosDefaultTc\x88\x01\x01\x129\n" +
	"\x13qos_dot1p_to_tc_map\x18\x1e \x01(\x04B\x06\xf0ܓ\xad\x0fjH\x1dR\x0fqosDot1pToTcMap\x88\x01\x01\x12?\n" +
	"\x16qos_dot1p_to_color_map\x18\x1f \x01(\x04B\x06\xf0ܓ\xad\x0fkH\x1eR\x12qosDot1pToColorMap\x88\x01\x01\x127\n" +
	"\x12qos_dscp_to_tc_map\x18  \x01(\x04B\x06\xf0ܓ\xad\x0flH\x1fR\x0eqosDscpToTcMap\x88\x01\x01\x12=\n" +
	"\x15qos_dscp_to_color_map\x18! \x01(\x04B\x06\xf0ܓ\xad\x0fmH R\x11qosDscpToColorMap\x88\x01\x01\x129\n" +
	"\x13qos_tc_to_queue_map\x18\" \x01(\x04B\x06\xf0ܓ\xad\x0fnH!R\x0fqosTcToQueueMap\x88\x01\x01\x12K\n" +
	"\x1dqos_tc_and_color_to_dot1p_map\x18# \x01(\x04B\x06\xf0ܓ\xad\x0foH\"R\x17qosTcAndColorToDot1pMap\x88\x01\x01\x12I\n" +
	"\x1cqos_tc_and_color_to_dscp_map\x18$ \x01(\x04B\x06\xf0ܓ\xad\x0fpH#R\x16qosTcAndColorToDscpMap\x88\x01\x01\x12;\n" +
	"\x13switch_shell_enable\x18% \x01(\bB\x06\xf0ܓ\xad\x0fqH$R\x11switchShellEnable\x88\x01\x01\x127\n" +
	"\x11switch_profile_id\x18& \x01(\rB\x06\xf0ܓ\xad\x0frH%R\x0fswitchProfileId\x88\x01\x01\x128\n" +
	"\x14switch_hardware_info\x18' \x03(\x05B\x06\xf0ܓ\xad\x0fsR\x12switchHardwareInfo\x124\n" +
	"\x12firmware_path_name\x18( \x03(\x05B\x06\xf0ܓ\xad\x0ftR\x10firmwarePathName\x12,\n" +
	"\vinit_switch\x18) \x01(\bB\x06\xf0ܓ\xad\x0fuH&R\n" +
	"initSwitch\x88\x01\x01\x123\n" +
	"\x0ffast_api_enable\x18* \x01(\bB\x06\xf0ܓ\xad\x0f{H'R\rfastApiEnable\x88\x01\x01\x12(\n" +
	"\tmirror_tc\x18+ \x01(\rB\x06\xf0ܓ\xad\x0f|H(R\bmirrorTc\x88\x01\x01\x12d\n" +
	"\x15pfc_dlr_packet_action\x18, \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\a\xf0ܓ\xad\x0f\x83\x01H)R\x12pfcDlrPacketAction\x88\x01\x01\x12V\n" +
	"\x13pfc_tc_dld_interval\x18- \x03(\v2\x1e.lemming.dataplane.sai.UintMapB\a\xf0ܓ\xad\x0f\x85\x01R\x10pfcTcDldInterval\x12V\n" +
	"\x13pfc_tc_dlr_interval\x18. \x03(\v2\x1e.lemming.dataplane.sai.UintMapB\a\xf0ܓ\xad\x0f\x87\x01R\x10pfcTcDlrInterval\x124\n" +
	"\x0ftpid_outer_vlan\x18/ \x01(\rB\a\xf0ܓ\xad\x0f\x89\x01H*R\rtpidOuterVlan\x88\x01\x01\x124\n" +
	"\x0ftpid_inner_vlan\x180 \x01(\rB\a\xf0ܓ\xad\x0f\x8a\x01H+R\rtpidInnerVlan\x88\x01\x01\x126\n" +
	"\x10crc_check_enable\x181 \x01(\bB\a\xf0ܓ\xad\x0f\x8b\x01H,R\x0ecrcCheckEnable\x88\x01\x01\x12F\n" +
	"\x18crc_recalculation_enable\x182 \x01(\bB\a\xf0ܓ\xad\x0f\x8c\x01H-R\x16crcRecalculationEnable\x88\x01\x01\x12E\n" +
	"\x18ecn_ect_threshold_enable\x183 \x01(\bB\a\xf0ܓ\xad\x0f\x94\x01H.R\x15ecnEctThresholdEnable\x88\x01\x01\x12E\n" +
	"\x18vxlan_default_router_mac\x184 \x01(\fB\a\xf0ܓ\xad\x0f\x95\x01H/R\x15vxlanDefaultRouterMac\x88\x01\x01\x12:\n" +
	"\x12vxlan_default_port\x185 \x01(\rB\a\xf0ܓ\xad\x0f\x96\x01H0R\x10vxlanDefaultPort\x88\x01\x01\x12L\n" +
	"\x1cuninit_data_plane_on_removal\x186 \x01(\bB\a\xf0ܓ\xad\x0f\x9a\x01H1R\x18uninitDataPlaneOnRemoval\x88\x01\x01\x12+\n" +
	"\rtam_object_id\x187 \x03(\x04B\a\xf0ܓ\xad\x0f\x9b\x01R\vtamObjectId\x12/\n" +
	"\fpre_shutdown\x188 \x01(\bB\a\xf0ܓ\xad\x0f\x9e\x01H2R\vpreShutdown\x88\x01\x01\x12H\n" +
	"\x1anat_zone_counter_object_id\x189 \x01(\x04B\a\xf0ܓ\xad\x0f\x9f\x01H3R\x16natZoneCounterObjectId\x88\x01\x01\x12+\n" +
	"\n" +
	"nat_enable\x18: \x01(\bB\a\xf0ܓ\xad\x0f\xa0\x01H4R\tnatEnable\x88\x01\x01\x12l\n" +
	"\x13hardware_access_bus\x18; \x01(\x0e2..lemming.dataplane.sai.SwitchHardwareAccessBusB\a\xf0ܓ\xad\x0f\xa1\x01H5R\x11hardwareAccessBus\x88\x01\x01\x127\n" +
	"\x10platfrom_context\x18< \x01(\x04B\a\xf0ܓ\xad\x0f\xa2\x01H6R\x0fplatfromContext\x88\x01\x01\x12L\n" +
	"\x1bfirmware_download_broadcast\x18= \x01(\bB\a\xf0ܓ\xad\x0f\xa5\x01H7R\x19firmwareDownloadBroadcast\x88\x01\x01\x12o\n" +
	"\x14firmware_load_method\x18> \x01(\x0e2/.lemming.dataplane.sai.SwitchFirmwareLoadMethodB\a\xf0ܓ\xad\x0f\xa6\x01H8R\x12firmwareLoadMethod\x88\x01\x01\x12i\n" +
	"\x12firmware_load_type\x18? \x01(\x0e2-.lemming.dataplane.sai.SwitchFirmwareLoadTypeB\a\xf0ܓ\xad\x0f\xa7\x01H9R\x10firmwareLoadType\x88\x01\x01\x12H\n" +
	"\x19firmware_download_execute\x18@ \x01(\bB\a\xf0ܓ\xad\x0f\xa8\x01H:R\x17firmwareDownloadExecute\x88\x01\x01\x12D\n" +
	"\x17firmware_broadcast_stop\x18A \x01(\bB\a\xf0ܓ\xad\x0f\xa9\x01H;R\x15firmwareBroadcastStop\x88\x01\x01\x12R\n" +
	"\x1ffirmware_verify_and_init_switch\x18B \x01(\bB\a\xf0ܓ\xad\x0f\xaa\x01H<R\x1bfirmwareVerifyAndInitSwitch\x88\x01\x01\x12C\n" +
	"\x04type\x18C \x01(\x0e2!.lemming.dataplane.sai.SwitchTypeB\a\xf0ܓ\xad\x0f\xb0\x01H=R\x04type\x88\x01\x01\x125\n" +
	"\x12macsec_object_list\x18D \x03(\x04B\a\xf0ܓ\xad\x0f\xb1\x01R\x10macsecObjectList\x12?\n" +
	"\x16qos_mpls_exp_to_tc_map\x18E \x01(\x04B\a\xf0ܓ\xad\x0f\xb2\x01H>R\x11qosMplsExpToTcMap\x88\x01\x01\x12E\n" +
	"\x19qos_mpls_exp_to_color_map\x18F \x01(\x04B\a\xf0ܓ\xad\x0f\xb3\x01H?R\x14qosMplsExpToColorMap\x88\x01\x01\x12Q\n" +
	" qos_tc_and_color_to_mpls_exp_map\x18G \x01(\x04B\a\xf0ܓ\xad\x0f\xb4\x01H@R\x19qosTcAndColorToMplsExpMap\x88\x01\x01\x12)\n" +
	"\tswitch_id\x18H \x01(\rB\a\xf0ܓ\xad\x0f\xb5\x01HAR\bswitchId\x88\x01\x01\x126\n" +
	"\x10max_system_cores\x18I \x01(\rB\a\xf0ܓ\xad\x0f\xb6\x01HBR\x0emaxSystemCores\x88\x01\x01\x12g\n" +
	"\x17system_port_config_list\x18J \x03(\v2'.lemming.dataplane.sai.SystemPortConfigB\a\xf0ܓ\xad\x0f\xb7\x01R\x14systemPortConfigList\x12o\n" +
	"\x14failover_config_mode\x18K \x01(\x0e2/.lemming.dataplane.sai.SwitchFailoverConfigModeB\a\xf0ܓ\xad\x0f\xbd\x01HCR\x12failoverConfigMode\x88\x01\x01\x127\n" +
	"\x13tunnel_objects_list\x18L \x03(\x04B\a\xf0ܓ\xad\x0f\xbf\x01R\x11tunnelObjectsList\x124\n" +
	"\x0fpre_ingress_acl\x18M \x01(\x04B\a\xf0ܓ\xad\x0f\xc1\x01HDR\rpreIngressAcl\x88\x01\x01\x128\n" +
	"\x14slave_mdio_addr_list\x18N \x03(\rB\a\xf0ܓ\xad\x0f\xc5\x01R\x11slaveMdioAddrList\x12S\n" +
	" qos_dscp_to_forwarding_class_map\x18O \x01(\x04B\a\xf0ܓ\xad\x0f\xcc\x01HER\x1bqosDscpToForwardingClassMap\x88\x01\x01\x12Z\n" +
	"$qos_mpls_exp_to_forwarding_class_map\x18P \x01(\x04B\a\xf0ܓ\xad\x0f\xcd\x01HFR\x1eqosMplsExpToForwardingClassMap\x88\x01\x01\x124\n" +
	"\x0fipsec_object_id\x18Q \x01(\x04B\a\xf0ܓ\xad\x0f\xce\x01HGR\ripsecObjectId\x88\x01\x01\x127\n" +
	"\x11ipsec_sa_tag_tpid\x18R \x01(\rB\a\xf0ܓ\xad\x0f\xcf\x01HHR\x0eipsecSaTagTpid\x88\x01\x01\x128\n" +
	"\x11ecmp_member_count\x18S \x01(\rB\a\xf0ܓ\xad\x0f\xd3\x01HIR\x0fecmpMemberCount\x88\x01\x01\x12-\n" +
	"\vars_profile\x18T \x01(\x04B\a\xf0ܓ\xad\x0f\xd4\x01HJR\n" +
	"arsProfile\x88\x01\x01\x12)\n" +
	"\tcredit_wd\x18U \x01(\bB\a\xf0ܓ\xad\x0f\xd6\x01HKR\bcreditWd\x88\x01\x01\x124\n" +
	"\x0fcredit_wd_timer\x18V \x01(\rB\a\xf0ܓ\xad\x0f\xd7\x01HLR\rcreditWdTimer\x88\x01\x01\x123\n" +
	"\x0eswitch_isolate\x18W \x01(\bB\a\xf0ܓ\xad\x0f\xd8\x01HMR\rswitchIsolate\x88\x01\x01\x12\x89\x01\n" +
	"\x1ehostif_oper_status_update_mode\x18X \x01(\x0e27.lemming.dataplane.sai.SwitchHostifOperStatusUpdateModeB\a\xf0ܓ\xad\x0f\xd9\x01HNR\x1ahostifOperStatusUpdateMode\x88\x01\x01\x12\x93\x01\n" +
	")reg_fatal_switch_asic_sdk_health_category\x18Y \x03(\x0e22.lemming.dataplane.sai.SwitchAsicSdkHealthCategoryB\a\xf0ܓ\xad\x0f\xdb\x01R#regFatalSwitchAsicSdkHealthCategory\x12\x97\x01\n" +
	"+reg_warning_switch_asic_sdk_health_category\x18Z \x03(\x0e22.lemming.dataplane.sai.SwitchAsicSdkHealthCategoryB\a\xf0ܓ\xad\x0f\xdc\x01R%regWarningSwitchAsicSdkHealthCategory\x12\x95\x01\n" +
	...
	"\r_restart_warmB\x0f\n" +
	"\r_warm_recoverB\x11\n" +
	"\x0f_switching_modeB\x19\n" +
	"\x17_bcast_cpu_flood_enableB\x19\n" +
	"\x17_mcast_cpu_flood_enableB\x12\n" +
	"\x10_src_mac_addressB\x18\n" +
	"\x16_max_learned_addressesB\x11\n" +
	"\x0f_fdb_aging_timeB!\n" +
	"\x1f_fdb_unicast_miss_packet_actionB#\n" +
	"!_fdb_broadcast_miss_packet_actionB#\n" +
	"!_fdb_multicast_miss_packet_actionB\x1e\n" +
	"\x1c_ecmp_default_hash_algorithmB\x19\n" +
	"\x17_ecmp_default_hash_seedB\x1b\n" +
	"\x19_ecmp_default_hash_offsetB\x1e\n" +
	"\x1c_ecmp_default_symmetric_hashB\x11\n" +
	"\x0f_ecmp_hash_ipv4B\x19\n" +
	"\x17_ecmp_hash_ipv4_in_ipv4B\x11\n" +
	"\x0f_ecmp_hash_ipv6B\x1d\n" +
	"\x1b_lag_default_hash_algorithmB\x18\n" +
	"\x16_lag_default_hash_seedB\x1a\n" +
	"\x18_lag_default_hash_offsetB\x1d\n" +
	"\x1b_lag_default_symmetric_hashB\x10\n" +
	"\x0e_lag_hash_ipv4B\x18\n" +
	"\x16_lag_hash_ipv4_in_ipv4B\x10\n" +
	"\x0e_lag_hash_ipv6B\x1b\n" +
	"\x19_counter_refresh_intervalB\x11\n" +
	"\x0f_qos_default_tcB\x16\n" +
	"\x14_qos_dot1p_to_tc_mapB\x19\n" +
	"\x17_qos_dot1p_to_color_mapB\x15\n" +
	"\x13_qos_dscp_to_tc_mapB\x18\n" +
	"\x16_qos_dscp_to_color_mapB\x16\n" +
	"\x14_qos_tc_to_queue_mapB \n" +
	"\x1e_qos_tc_and_color_to_dot1p_mapB\x1f\n" +
	"\x1d_qos_tc_and_color_to_dscp_mapB\x16\n" +
	"\x14_switch_shell_enableB\x14\n" +
	"\x12_switch_profile_idB\x0e\n" +
	"\f_init_switchB\x12\n" +
	"\x10_fast_api_enableB\f\n" +
	"\n" +
	"_mirror_tcB\x18\n" +
	"\x16_pfc_dlr_packet_actionB\x12\n" +
	"\x10_tpid_outer_vlanB\x12\n" +
	"\x10_tpid_inner_vlanB\x13\n" +
	"\x11_crc_check_enableB\x1b\n" +
	"\x19_crc_recalculation_enableB\x1b\n" +
	"\x19_ecn_ect_threshold_enableB\x1b\n" +
	"\x19_vxlan_default_router_macB\x15\n" +
	"\x13_vxlan_default_portB\x1f\n" +
	"\x1d_uninit_data_plane_on_removalB\x0f\n" +
	"\r_pre_shutdownB\x1d\n" +
	"\x1b_nat_zone_counter_object_idB\r\n" +
	"\v_nat_enableB\x16\n" +
	"\x14_hardware_access_busB\x13\n" +
	"\x11_platfrom_contextB\x1e\n" +
	"\x1c_firmware_download_broadcastB\x17\n" +
	"\x15_firmware_load_methodB\x15\n" +
	"\x13_firmware_load_typeB\x1c\n" +
	"\x1a_firmware_download_executeB\x1a\n" +
	"\x18_firmware_broadcast_stopB\"\n" +
	" _firmware_verify_and_init_switchB\a\n" +
	"\x05_typeB\x19\n" +
	"\x17_qos_mpls_exp_to_tc_mapB\x1c\n" +
	"\x1a_qos_mpls_exp_to_color_mapB#\n" +
	"!_qos_tc_and_color_to_mpls_exp_mapB\f\n" +
	"\n" +
	"_switch_idB\x13\n" +
	"\x11_max_system_coresB\x17\n" +
	"\x15_failover_config_modeB\x12\n" +
	"\x10_pre_ingress_aclB#\n" +
	"!_qos_dscp_to_forwarding_class_mapB'\n" +
	"%_qos_mpls_exp_to_forwarding_class_mapB\x12\n" +
	"\x10_ipsec_object_idB\x14\n" +
	"\x12_ipsec_sa_tag_tpidB\x14\n" +
	"\x12_ecmp_member_countB\x0e\n" +
	"\f_ars_profileB\f\n" +
	"\n" +
	"_credit_wdB\x12\n" +
	...
	"ingressAcl\x88\x01\x01\x12*\n" +
	"\n" +
	"egress_acl\x18\x03 \x01(\x04B\x06\xf0ܓ\xad\x0f,H\x01R\tegressAcl\x88\x01\x01\x12.\n" +
	"\frestart_warm\x18\x04 \x01(\bB\x06\xf0ܓ\xad\x0fHH\x02R\vrestartWarm\x88\x01\x01\x12.\n" +
	"\fwarm_recover\x18\x05 \x01(\bB\x06\xf0ܓ\xad\x0fIH\x03R\vwarmRecover\x88\x01\x01\x12^\n" +
	"\x0eswitching_mode\x18\x06 \x01(\x0e2*.lemming.dataplane.sai.SwitchSwitchingModeB\x06\xf0ܓ\xad\x0fQH\x04R\rswitchingMode\x88\x01\x01\x12@\n" +
	"\x16bcast_cpu_flood_enable\x18\a \x01(\bB\x06\xf0ܓ\xad\x0fRH\x05R\x13bcastCpuFloodEnable\x88\x01\x01\x12@\n" +
	"\x16mcast_cpu_flood_enable\x18\b \x01(\bB\x06\xf0ܓ\xad\x0fSH\x06R\x13mcastCpuFloodEnable\x88\x01\x01\x123\n" +
	"\x0fsrc_mac_address\x18\t \x01(\fB\x06\xf0ܓ\xad\x0fTH\aR\rsrcMacAddress\x88\x01\x01\x12?\n" +
	"\x15max_learned_addresses\x18\n" +
	" \x01(\rB\x06\xf0ܓ\xad\x0fUH\bR\x13maxLearnedAddresses\x88\x01\x01\x121\n" +
	"\x0efdb_aging_time\x18\v \x01(\rB\x06\xf0ܓ\xad\x0fVH\tR\ffdbAgingTime\x88\x01\x01\x12t\n" +
	"\x1efdb_unicast_miss_packet_action\x18\f \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fWH\n" +
	"R\x1afdbUnicastMissPacketAction\x88\x01\x01\x12x\n" +
	" fdb_broadcast_miss_packet_action\x18\r \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fXH\vR\x1cfdbBroadcastMissPacketAction\x88\x01\x01\x12x\n" +
	" fdb_multicast_miss_packet_action\x18\x0e \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0fYH\fR\x1cfdbMulticastMissPacketAction\x88\x01\x01\x12p\n" +
	"\x1becmp_default_hash_algorithm\x18\x0f \x01(\x0e2$.lemming.dataplane.sai.HashAlgorithmB\x06\xf0ܓ\xad\x0fZH\rR\x18ecmpDefaultHashAlgorithm\x88\x01\x01\x12@\n" +
	"\x16ecmp_default_hash_seed\x18\x10 \x01(\rB\x06\xf0ܓ\xad\x0f[H\x0eR\x13ecmpDefaultHashSeed\x88\x01\x01\x12D\n" +
	"\x18ecmp_default_hash_offset\x18\x11 \x01(\rB\x06\xf0ܓ\xad\x0f\\H\x0fR\x15ecmpDefaultHashOffset\x88\x01\x01\x12J\n" +
	"\x1becmp_default_symmetric_hash\x18\x12 \x01(\bB\x06\xf0ܓ\xad\x0f]H\x10R\x18ecmpDefaultSymmetricHash\x88\x01\x01\x121\n" +
	"\x0eecmp_hash_ipv4\x18\x13 \x01(\x04B\x06\xf0ܓ\xad\x0f^H\x11R\fecmpHashIpv4\x88\x01\x01\x12?\n" +
	"\x16ecmp_hash_ipv4_in_ipv4\x18\x14 \x01(\x04B\x06\xf0ܓ\xad\x0f_H\x12R\x12ecmpHashIpv4InIpv4\x88\x01\x01\x121\n" +
	"\x0eecmp_hash_ipv6\x18\x15 \x01(\x04B\x06\xf0ܓ\xad\x0f`H\x13R\fecmpHashIpv6\x88\x01\x01\x12n\n" +
	"\x1alag_default_hash_algorithm\x18\x16 \x01(\x0e2$.lemming.dataplane.sai.HashAlgorithmB\x06\xf0ܓ\xad\x0faH\x14R\x17lagDefaultHashAlgorithm\x88\x01\x01\x12>\n" +
	"\x15lag_default_hash_seed\x18\x17 \x01(\rB\x06\xf0ܓ\xad\x0fbH\x15R\x12lagDefaultHashSeed\x88\x01\x01\x12B\n" +
	"\x17lag_default_hash_offset\x18\x18 \x01(\rB\x06\xf0ܓ\xad\x0fcH\x16R\x14lagDefaultHashOffset\x88\x01\x01\x12H\n" +
	"\x1alag_default_symmetric_hash\x18\x19 \x01(\bB\x06\xf0ܓ\xad\x0fdH\x17R\x17lagDefaultSymmetricHash\x88\x01\x01\x12/\n" +
	"\rlag_hash_ipv4\x18\x1a \x01(\x04B\x06\xf0ܓ\xad\x0feH\x18R\vlagHashIpv4\x88\x01\x01\x12=\n" +
	"\x15lag_hash_ipv4_in_ipv4\x18\x1b \x01(\x04B\x06\xf0ܓ\xad\x0ffH\x19R\x11lagHashIpv4InIpv4\x88\x01\x01\x12/\n" +
	"\rlag_hash_ipv6\x18\x1c \x01(\x04B\x06\xf0ܓ\xad\x0fgH\x1aR\vlagHashIpv6\x88\x01\x01\x12E\n" +
	"\x18counter_refresh_interval\x18\x1d \x01(\rB\x06\xf0ܓ\xad\x0fhH\x1bR\x16counterRefreshInterval\x88\x01\x01\x121\n" +
	"\x0eqos_default_tc\x18\x1e \x01(\rB\x06\xf0ܓ\xad\x0fiH\x1cR\fqosDefaultTc\x88\x01\x01\x129\n" +
	"\x13qos_dot1p_to_tc_map\x18\x1f \x01(\x04B\x06\xf0ܓ\xad\x0fjH\x1dR\x0fqosDot1pToTcMap\x88\x01\x01\x12?\n" +
	"\x16qos_dot1p_to_color_map\x18  \x01(\x04B\x06\xf0ܓ\xad\x0fkH\x1eR\x12qosDot1pToColorMap\x88\x01\x01\x127\n" +
	"\x12qos_dscp_to_tc_map\x18! \x01(\x04B\x06\xf0ܓ\xad\x0flH\x1fR\x0eqosDscpToTcMap\x88\x01\x01\x12=\n" +
	"\x15qos_dscp_to_color_map\x18\" \x01(\x04B\x06\xf0ܓ\xad\x0fmH R\x11qosDscpToColorMap\x88\x01\x01\x129\n" +
	"\x13qos_tc_to_queue_map\x18# \x01(\x04B\x06\xf0ܓ\xad\x0fnH!R\x0fqosTcToQueueMap\x88\x01\x01\x12K\n" +
	"\x1dqos_tc_and_color_to_dot1p_map\x18$ \x01(\x04B\x06\xf0ܓ\xad\x0foH\"R\x17qosTcAndColorToDot1pMap\x88\x01\x01\x12I\n" +
	"\x1cqos_tc_and_color_to_dscp_map\x18% \x01(\x04B\x06\xf0ܓ\xad\x0fpH#R\x16qosTcAndColorToDscpMap\x88\x01\x01\x12;\n" +
	"\x13switch_shell_enable\x18& \x01(\bB\x06\xf0ܓ\xad\x0fqH$R\x11switchShellEnable\x88\x01\x01\x123\n" +
	"\x0ffast_api_enable\x18' \x01(\bB\x06\xf0ܓ\xad\x0f{H%R\rfastApiEnable\x88\x01\x01\x12(\n" +
	"\tmirror_tc\x18( \x01(\rB\x06\xf0ܓ\xad\x0f|H&R\bmirrorTc\x88\x01\x01\x12d\n" +
	"\x15pfc_dlr_packet_action\x18) \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\a\xf0ܓ\xad\x0f\x83\x01H'R\x12pfcDlrPacketAction\x88\x01\x01\x12V\n" +
	"\x13pfc_tc_dld_interval\x18* \x03(\v2\x1e.lemming.dataplane.sai.UintMapB\a\xf0ܓ\xad\x0f\x85\x01R\x10pfcTcDldInterval\x12V\n" +
	"\x13pfc_tc_dlr_interval\x18+ \x03(\v2\x1e.lemming.dataplane.sai.UintMapB\a\xf0ܓ\xad\x0f\x87\x01R\x10pfcTcDlrInterval\x124\n" +
	"\x0ftpid_outer_vlan\x18, \x01(\rB\a\xf0ܓ\xad\x0f\x89\x01H(R\rtpidOuterVlan\x88\x01\x01\x124\n" +
	"\x0ftpid_inner_vlan\x18- \x01(\rB\a\xf0ܓ\xad\x0f\x8a\x01H)R\rtpidInnerVlan\x88\x01\x01\x126\n" +
	"\x10crc_check_enable\x18. \x01(\bB\a\xf0ܓ\xad\x0f\x8b\x01H*R\x0ecrcCheckEnable\x88\x01\x01\x12F\n" +
	"\x18crc_recalculation_enable\x18/ \x01(\bB\a\xf0ܓ\xad\x0f\x8c\x01H+R\x16crcRecalculationEnable\x88\x01\x01\x12E\n" +
	"\x18ecn_ect_threshold_enable\x180 \x01(\bB\a\xf0ܓ\xad\x0f\x94\x01H,R\x15ecnEctThresholdEnable\x88\x01\x01\x12E\n" +
	"\x18vxlan_default_router_mac\x181 \x01(\fB\a\xf0ܓ\xad\x0f\x95\x01H-R\x15vxlanDefaultRouterMac\x88\x01\x01\x12:\n" +
	"\x12vxlan_default_port\x182 \x01(\rB\a\xf0ܓ\xad\x0f\x96\x01H.R\x10vxlanDefaultPort\x88\x01\x01\x12L\n" +
	"\x1cuninit_data_plane_on_removal\x183 \x01(\bB\a\xf0ܓ\xad\x0f\x9a\x01H/R\x18uninitDataPlaneOnRemoval\x88\x01\x01\x12+\n" +
	"\rtam_object_id\x184 \x03(\x04B\a\xf0ܓ\xad\x0f\x9b\x01R\vtamObjectId\x12/\n" +
	"\fpre_shutdown\x185 \x01(\bB\a\xf0ܓ\xad\x0f\x9e\x01H0R\vpreShutdown\x88\x01\x01\x12H\n" +
	"\x1anat_zone_counter_object_id\x186 \x01(\x04B\a\xf0ܓ\xad\x0f\x9f\x01H1R\x16natZoneCounterObjectId\x88\x01\x01\x12+\n" +
	"\n" +
	"nat_enable\x187 \x01(\bB\a\xf0ܓ\xad\x0f\xa0\x01H2R\tnatEnable\x88\x01\x01\x12H\n" +
	"\x19firmware_download_execute\x188 \x01(\bB\a\xf0ܓ\xad\x0f\xa8\x01H3R\x17firmwareDownloadExecute\x88\x01\x01\x12D\n" +
	"\x17firmware_broadcast_stop\x189 \x01(\bB\a\xf0ܓ\xad\x0f\xa9\x01H4R\x15firmwareBroadcastStop\x88\x01\x01\x12R\n" +
	"\x1ffirmware_verify_and_init_switch\x18: \x01(\bB\a\xf0ܓ\xad\x0f\xaa\x01H5R\x1bfirmwareVerifyAndInitSwitch\x88\x01\x01\x125\n" +
	"\x12macsec_object_list\x18; \x03(\x04B\a\xf0ܓ\xad\x0f\xb1\x01R\x10macsecObjectList\x12?\n" +
	"\x16qos_mpls_exp_to_tc_map\x18< \x01(\x04B\a\xf0ܓ\xad\x0f\xb2\x01H6R\x11qosMplsExpToTcMap\x88\x01\x01\x12E\n" +
	"\x19qos_mpls_exp_to_color_map\x18= \x01(\x04B\a\xf0ܓ\xad\x0f\xb3\x01H7R\x14qosMplsExpToColorMap\x88\x01\x01\x12Q\n" +
	" qos_tc_and_color_to_mpls_exp_map\x18> \x01(\x04B\a\xf0ܓ\xad\x0f\xb4\x01H8R\x19qosTcAndColorToMplsExpMap\x88\x01\x01\x12o\n" +
	"\x14failover_config_mode\x18? \x01(\x0e2/.lemming.dataplane.sai.SwitchFailoverConfigModeB\a\xf0ܓ\xad\x0f\xbd\x01H9R\x12failoverConfigMode\x88\x01\x01\x127\n" +
	"\x13tunnel_objects_list\x18@ \x03(\x04B\a\xf0ܓ\xad\x0f\xbf\x01R\x11tunnelObjectsList\x124\n" +
	"\x0fpre_ingress_acl\x18A \x01(\x04B\a\xf0ܓ\xad\x0f\xc1\x01H:R\rpreIngressAcl\x88\x01\x01\x12S\n" +
	" qos_dscp_to_forwarding_class_map\x18B \x01(\x04B\a\xf0ܓ\xad\x0f\xcc\x01H;R\x1bqosDscpToForwardingClassMap\x88\x01\x01\x12Z\n" +
	"$qos_mpls_exp_to_forwarding_class_map\x18C \x01(\x04B\a\xf0ܓ\xad\x0f\xcd\x01H<R\x1eqosMplsExpToForwardingClassMap\x88\x01\x01\x124\n" +
	"\x0fipsec_object_id\x18D \x01(\x04B\a\xf0ܓ\xad\x0f\xce\x01H=R\ripsecObjectId\x88\x01\x01\x127\n" +
	"\x11ipsec_sa_tag_tpid\x18E \x01(\rB\a\xf0ܓ\xad\x0f\xcf\x01H>R\x0eipsecSaTagTpid\x88\x01\x01\x128\n" +
	"\x11ecmp_member_count\x18F \x01(\rB\a\xf0ܓ\xad\x0f\xd3\x01H?R\x0fecmpMemberCount\x88\x01\x01\x12-\n" +
	"\vars_profile\x18G \x01(\x04B\a\xf0ܓ\xad\x0f\xd4\x01H@R\n" +
	"arsProfile\x88\x01\x01\x12)\n" +
	"\tcredit_wd\x18H \x01(\bB\a\xf0ܓ\xad\x0f\xd6\x01HAR\bcreditWd\x88\x01\x01\x124\n" +
	"\x0fcredit_wd_timer\x18I \x01(\rB\a\xf0ܓ\xad\x0f\xd7\x01HBR\rcreditWdTimer\x88\x01\x01\x123\n" +
	"\x0eswitch_isolate\x18J \x01(\bB\a\xf0ܓ\xad\x0f\xd8\x01HCR\rswitchIsolate\x88\x01\x01\x12\x89\x01\n" +
	"\x1ehostif_oper_status_update_mode\x18K \x01(\x0e27.lemming.dataplane.sai.SwitchHostifOperStatusUpdateModeB\a\xf0ܓ\xad\x0f\xd9\x01HDR\x1ahostifOperStatusUpdateMode\x88\x01\x01\x12\x93\x01\n" +
	")reg_fatal_switch_asic_sdk_health_category\x18L \x03(\x0e22.lemming.dataplane.sai.SwitchAsicSdkHealthCategoryB\a\xf0ܓ\xad\x0f\xdb\x01R#regFatalSwitchAsicSdkHealthCategory\x12\x97\x01\n" +
	"+reg_warning_switch_asic_sdk_health_category\x18M \x03(\x0e22.lemming.dataplane.sai.SwitchAsicSdkHealthCategoryB\a\xf0ܓ\xad\x0f\xdc\x01R%regWarningSwitchAsicSdkHealthCategory\x12\x95\x01\n" +
	...
	"\x16selective_counter_list\x18Q \x03(\x04B\a\xf0ܓ\xad\x0f\xed\x01R\x14selectiveCounterList\x12<\n" +
	"\x13disable_vlan_checks\x18R \x01(\bB\a\xf0ܓ\xad\x0f\xee\x01HFR\x11disableVlanChecks\x88\x01\x01\x12K\n" +
	"\x1bdisable_ingress_vlan_checks\x18S \x01(\bB\a\xf0ܓ\xad\x0f\xef\x01HGR\x18disableIngressVlanChecks\x88\x01\x01\x12I\n" +
	"\x1adisable_egress_vlan_checks\x18T \x01(\bB\a\xf0ܓ\xad\x0f\xf0\x01HHR\x17disableEgressVlanChecks\x88\x01\x01B\x0e\n" +
	"\f_ingress_aclB\r\n" +
	"\v_egress_aclB\x0f\n" +
	"\r_restart_warmB\x0f\n" +
	"\r_warm_recoverB\x11\n" +
	...
	"\x1a_firmware_download_executeB\x1a\n" +
	"\x18_firmware_broadcast_stopB\"\n" +
	" _firmware_verify_and_init_switchB\x19\n" +
	"\x17_qos_mpls_exp_to_tc_mapB\x1c\n" +
	"\x1a_qos_mpls_exp_to_color_mapB#\n" +
	"!_qos_tc_and_color_to_mpls_exp_mapB\x17\n" +
	"\x15_failover_config_modeB\x12\n" +
	"\x10_pre_ingress_aclB#\n" +
	"!_qos_dscp_to_forwarding_class_mapB'\n" +
	"%_qos_mpls_exp_to_forwarding_class_mapB\x12\n" +
	...
	"\x03oid\x18\x01 \x01(\x04R\x03oid\x12>\n" +
	"\tattr_type\x18\x02 \x03(\x0e2!.lemming.dataplane.sai.SwitchAttrR\battrType\"X\n" +
	"\x1aGetSwitchAttributeResponse\x12:\n" +
	"\x04attr\x18\x01 \x01(\v2&.lemming.dataplane.sai.SwitchAttributeR\x04attr\"&\n" +
	"$SwitchStateChangeNotificationRequest\"\x9b\x01\n" +
	"%SwitchStateChangeNotificationResponse\x12\x1b\n" +
	"\tswitch_id\x18\x01 \x01(\x04R\bswitchId\x12U\n" +
	"\x12switch_oper_status\x18\x02 \x01(\x0e2'.lemming.dataplane.sai.SwitchOperStatusR\x10switchOperStatus\"*\n" +
	"(SwitchShutdownRequestNotificationRequest\"H\n" +
	")SwitchShutdownRequestNotificationResponse\x12\x1b\n" +
	"\tswitch_id\x18\x01 \x01(\x04R\bswitchId\"\x1d\n" +
	"\x1bFdbEventNotificationRequest\"c\n" +
	"\x1cFdbEventNotificationResponse\x12C\n" +
	"\x04data\x18\x01 \x03(\v2/.lemming.dataplane.sai.FdbEventNotificationDataR\x04data\"$\n" +
	"\"PortStateChangeNotificationRequest\"l\n" +
	"#PortStateChangeNotificationResponse\x12E\n" +
	"\x04data\x18\x01 \x03(\v21.lemming.dataplane.sai.PortOperStatusNotificationR\x04data\" \n" +
	"\x1ePacketEventNotificationRequest\"\x9a\x01\n" +
	"\x1fPacketEventNotificationResponse\x12\x1b\n" +
	"\tswitch_id\x18\x01 \x01(\x04R\bswitchId\x12\x16\n" +
	"\x06buffer\x18\x02 \x01(\fR\x06buffer\x12B\n" +
	"\x05attrs\x18\x03 \x03(\v2,.lemming.dataplane.sai.HostifPacketAttributeR\x05attrs\"%\n" +
	"#QueuePfcDeadlockNotificationRequest\"p\n" +
	"$QueuePfcDeadlockNotificationResponse\x12H\n" +
	"\x04data\x18\x01 \x03(\v24.lemming.dataplane.sai.QueueDeadlockNotificationDataR\x04data\"*\n" +
	"(BfdSessionStateChangeNotificationRequest\"}\n" +
	")BfdSessionStateChangeNotificationResponse\x12P\n" +
	"\x04data\x18\x01 \x03(\v2<.lemming.dataplane.sai.BfdSessionStateChangeNotificationDataR\x04data\"\x1d\n" +
	"\x1bTamEventNotificationRequest\"\x9e\x01\n" +
	"\x1cTamEventNotificationResponse\x12 \n" +
	"\ftam_event_id\x18\x01 \x01(\x04R\n" +
	"tamEventId\x12\x16\n" +
	"\x06buffer\x18\x02 \x01(\fR\x06buffer\x12D\n" +
	"\x05attrs\x18\x03 \x03(\v2..lemming.dataplane.sai.TamEventActionAttributeR\x05attrs\"(\n" +
	"&IpsecSaStatusChangeNotificationRequest\"q\n" +
	"%IpsecSaStatusNotificationDataResponse\x12H\n" +
	"\x04data\x18\x01 \x03(\v24.lemming.dataplane.sai.IpsecSaStatusNotificationDataR\x04data\"m\n" +
	"\x15GetSwitchStatsRequest\x12\x10\n" +
	"\x03oid\x18\x01 \x01(\x04R\x03oid\x12B\n" +
	"\vcounter_ids\x18\x02 \x03(\x0e2!.lemming.dataplane.sai.SwitchStatR\n" +
	"counterIds\"0\n" +
	"\x16GetSwitchStatsResponse\x12\x16\n" +
	"\x06values\x18\x01 \x03(\x04R\x06values\"\xfe\n" +
	"\n" +
	"\x19CreateSwitchTunnelRequest\x12\x16\n" +
	"\x06switch\x18\x01 \x01(\x04R\x06switch\x12O\n" +
	"\vtunnel_type\x18\x02 \x01(\x0e2!.lemming.dataplane.sai.TunnelTypeB\x06\xf0ܓ\xad\x0f\x01H\x00R\n" +
	"tunnelType\x88\x01\x01\x12f\n" +
	"\x16loopback_packet_action\x18\x03 \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0f\x02H\x01R\x14loopbackPacketAction\x88\x01\x01\x12i\n" +
	"\x15tunnel_encap_ecn_mode\x18\x04 \x01(\x0e2).lemming.dataplane.sai.TunnelEncapEcnModeB\x06\xf0ܓ\xad\x0f\x03H\x02R\x12tunnelEncapEcnMode\x88\x01\x01\x12+\n" +
	"\rencap_mappers\x18\x05 \x03(\x04B\x06\xf0ܓ\xad\x0f\x04R\fencapMappers\x12i\n" +
	"\x15tunnel_decap_ecn_mode\x18\x06 \x01(\x0e2).lemming.dataplane.sai.TunnelDecapEcnModeB\x06\xf0ܓ\xad\x0f\x05H\x03R\x12tunnelDecapEcnMode\x88\x01\x01\x12+\n" +
	"\rdecap_mappers\x18\a \x03(\x04B\x06\xf0ܓ\xad\x0f\x06R\fdecapMappers\x12y\n" +
	"\x1btunnel_vxlan_udp_sport_mode\x18\b \x01(\x0e2..lemming.dataplane.sai.TunnelVxlanUdpSportModeB\x06\xf0ܓ\xad\x0f\aH\x04R\x17tunnelVxlanUdpSportMode\x88\x01\x01\x123\n" +
	"\x0fvxlan_udp_sport\x18\t \x01(\rB\x06\xf0ܓ\xad\x0f\bH\x05R\rvxlanUdpSport\x88\x01\x01\x12<\n" +
	"\x14vxlan_udp_sport_mask\x18\n" +
	" \x01(\rB\x06\xf0ܓ\xad\x0f\tH\x06R\x11vxlanUdpSportMask\x88\x01\x01\x12T\n" +
	"\"encap_qos_tc_and_color_to_dscp_map\x18\v \x01(\x04B\x06\xf0ܓ\xad\x0f\n" +
	"H\aR\x1bencapQosTcAndColorToDscpMap\x88\x01\x01\x12D\n" +
	"\x19encap_qos_tc_to_queue_map\x18\f \x01(\x04B\x06\xf0ܓ\xad\x0f\vH\bR\x14encapQosTcToQueueMap\x88\x01\x01\x12B\n" +
	"\x18decap_qos_dscp_to_tc_map\x18\r \x01(\x04B\x06\xf0ܓ\xad\x0f\fH\tR\x13decapQosDscpToTcMap\x88\x01\x01\x12U\n" +
	"\"decap_qos_tc_to_priority_group_map\x18\x0e \x01(\x04B\x06\xf0ܓ\xad\x0f\rH\n" +
	"R\x1cdecapQosTcToPriorityGroupMap\x88\x01\x01:\x06\xa0\xa9\x90\xad\x0f`B\x0e\n" +
	"\f_tunnel_typeB\x19\n" +
	"\x17_loopback_packet_actionB\x18\n" +
	"\x16_tunnel_encap_ecn_modeB\x18\n" +
	"\x16_tunnel_decap_ecn_modeB\x1e\n" +
	"\x1c_tunnel_vxlan_udp_sport_modeB\x12\n" +
	"\x10_vxlan_udp_sportB\x17\n" +
	"\x15_vxlan_udp_sport_maskB%\n" +
	"#_encap_qos_tc_and_color_to_dscp_mapB\x1c\n" +
	"\x1a_encap_qos_tc_to_queue_mapB\x1b\n" +
	"\x19_decap_qos_dscp_to_tc_mapB%\n" +
	"#_decap_qos_tc_to_priority_group_map\".\n" +
	"\x1aCreateSwitchTunnelResponse\x12\x10\n" +
	"\x03oid\x18\x01 \x01(\x04R\x03oid\"-\n" +
	"\x19RemoveSwitchTunnelRequest\x12\x10\n" +
	"\x03oid\x18\x01 \x01(\x04R\x03oid\"\x1c\n" +
	"\x1aRemoveSwitchTunnelResponse\"\xb1\a\n" +
	"\x1fSetSwitchTunnelAttributeRequest\x12\x10\n" +
	"\x03oid\x18\x01 \x01(\x04R\x03oid\x12f\n" +
	"\x16loopback_packet_action\x18\x02 \x01(\x0e2#.lemming.dataplane.sai.PacketActionB\x06\xf0ܓ\xad\x0f\x02H\x00R\x14loopbackPacketAction\x88\x01\x01\x12y\n" +
	"\x1btunnel_vxlan_udp_sport_mode\x18\x03 \x01(\x0e2..lemming.dataplane.sai.TunnelVxlanUdpSportModeB\x06\xf0ܓ\xad\x0f\aH\x01R\x17tunnelVxlanUdpSportMode\x88\x01\x01\x123\n" +
	"\x0fvxlan_udp_sport\x18\x04 \x01(\rB\x06\xf0ܓ\xad\x0f\bH\x02R\rvxlanUdpSport\x88\x01\x01\x12<\n" +
	"\x14vxlan_udp_sport_mask\x18\x05 \x01(\rB\x06\xf0ܓ\xad\x0f\tH\x03R\x11vxlanUdpSportMask\x88\x01\x01\x12T\n" +
	"\"encap_qos_tc_and_color_to_dscp_map\x18\x06 \x01(\x04B\x06\xf0ܓ\xad\x0f\n" +
	"H\x04R\x1bencapQosTcAndColorToDscpMap\x88\x01\x01\x12D\n" +
	"\x19encap_qos_tc_to_queue_map\x18\a \x01(\x04B\x06\xf0ܓ\xad\x0f\vH\x05R\x14encapQosTcToQueueMap\x88\x01\x01\x12B\n" +
	"\x18decap_qos_dscp_to_tc_map\x18\b \x01(\x04B\x06\xf0ܓ\xad\x0f\fH\x06R\x13decapQosDscpToTcMap\x88\x01\x01\x12U\n" +
	"\"decap_qos_tc_to_priority_group_map\x18\t \x01(\x04B\x06\xf0ܓ\xad\x0f\rH\aR\x1cdecapQosTcToPriorityGroupMap\x88\x01\x01B\x19\n" +
	"\x17_loopback_packet_actionB\x1e\n" +
	"\x1c_tunnel_vxlan_udp_sport_modeB\x12\n" +
	"\x10_vxlan_udp_sportB\x17\n" +
	"\x15_vxlan_udp_sport_maskB%\n" +
	"#_encap_qos_tc_and_color_to_dscp_mapB\x1c\n" +
	...
	"\x19_decap_qos_dscp_to_tc_mapB%\n" +
	"#_decap_qos_tc_to_priority_group_map\"\"\n" +
	" SetSwitchTunnelAttributeResponse\"y\n" +
	"\x1fGetSwitchTunnelAttributeRequest\x12\x10\n" +
	...
	"\x04attr\x18\x01 \x01(\v2,.lemming.dataplane.sai.SwitchTunnelAttributeR\x04attr*\x9eL\n" +
	"\n" +
	"SwitchAttr\x12\x1b\n" +
	"\x17SWITCH_ATTR_UNSPECIFIED\x10\x00\x12&\n" +
	"\"SWITCH_ATTR_NUMBER_OF_ACTIVE_PORTS\x10\x01\x12-\n" +
	")SWITCH_ATTR_MAX_NUMBER_OF_SUPPORTED_PORTS\x10\x02\x12\x19\n" +
	"\x15SWITCH_ATTR_PORT_LIST\x10\x03\x12\x1c\n" +
	"\x18SWITCH_ATTR_PORT_MAX_MTU\x10\x04\x12\x18\n" +
	"\x14SWITCH_ATTR_CPU_PORT\x10\x05\x12#\n" +
	"\x1fSWITCH_ATTR_MAX_VIRTUAL_ROUTERS\x10\x06\x12\x1e\n" +
	"\x1aSWITCH_ATTR_FDB_TABLE_SIZE\x10\a\x12&\n" +
	"\"SWITCH_ATTR_L3_NEIGHBOR_TABLE_SIZE\x10\b\x12#\n" +
	"\x1fSWITCH_ATTR_L3_ROUTE_TABLE_SIZE\x10\t\x12\x1b\n" +
	"\x17SWITCH_ATTR_LAG_MEMBERS\x10\n" +
	"\x12\x1e\n" +
	"\x1aSWITCH_ATTR_NUMBER_OF_LAGS\x10\v\x12\x1c\n" +
	"\x18SWITCH_ATTR_ECMP_MEMBERS\x10\f\x12%\n" +
	"!SWITCH_ATTR_NUMBER_OF_ECMP_GROUPS\x10\r\x12(\n" +
	"$SWITCH_ATTR_NUMBER_OF_UNICAST_QUEUES\x10\x0e\x12*\n" +
	"&SWITCH_ATTR_NUMBER_OF_MULTICAST_QUEUES\x10\x0f\x12 \n" +
	"\x1cSWITCH_ATTR_NUMBER_OF_QUEUES\x10\x10\x12$\n" +
	" SWITCH_ATTR_NUMBER_OF_CPU_QUEUES\x10\x11\x12'\n" +
	"#SWITCH_ATTR_ON_LINK_ROUTE_SUPPORTED\x10\x12\x12\x1b\n" +
	"\x17SWITCH_ATTR_OPER_STATUS\x10\x13\x12*\n" +
	"&SWITCH_ATTR_MAX_NUMBER_OF_TEMP_SENSORS\x10\x14\x12\x19\n" +
	"\x15SWITCH_ATTR_TEMP_LIST\x10\x15\x12\x18\n" +
	"\x14SWITCH_ATTR_MAX_TEMP\x10\x16\x12\x1c\n" +
	"\x18SWITCH_ATTR_AVERAGE_TEMP\x10\x17\x12*\n" +
	"&SWITCH_ATTR_ACL_TABLE_MINIMUM_PRIORITY\x10\x18\x12*\n" +
	"&SWITCH_ATTR_ACL_TABLE_MAXIMUM_PRIORITY\x10\x19\x12*\n" +
	"&SWITCH_ATTR_ACL_ENTRY_MINIMUM_PRIORITY\x10\x1a\x12*\n" +
	"&SWITCH_ATTR_ACL_ENTRY_MAXIMUM_PRIORITY\x10\x1b\x120\n" +
	",SWITCH_ATTR_ACL_TABLE_GROUP_MINIMUM_PRIORITY\x10\x1c\x120\n" +
	",SWITCH_ATTR_ACL_TABLE_GROUP_MAXIMUM_PRIORITY\x10\x1d\x12,\n" +
	"(SWITCH_ATTR_FDB_DST_USER_META_DATA_RANGE\x10\x1e\x12.\n" +
	"*SWITCH_ATTR_ROUTE_DST_USER_META_DATA_RANGE\x10\x1f\x121\n" +
	"-SWITCH_ATTR_NEIGHBOR_DST_USER_META_DATA_RANGE\x10 \x12)\n" +
	"%SWITCH_ATTR_PORT_USER_META_DATA_RANGE\x10!\x12)\n" +
	"%SWITCH_ATTR_VLAN_USER_META_DATA_RANGE\x10\"\x12(\n" +
	"$SWITCH_ATTR_ACL_USER_META_DATA_RANGE\x10#\x12&\n" +
	"\"SWITCH_ATTR_ACL_USER_TRAP_ID_RANGE\x10$\x12\x1f\n" +
	"\x1bSWITCH_ATTR_DEFAULT_VLAN_ID\x10%\x12#\n" +
	"\x1fSWITCH_ATTR_DEFAULT_STP_INST_ID\x10&\x12 \n" +
	"\x1cSWITCH_ATTR_MAX_STP_INSTANCE\x10'\x12)\n" +
	"%SWITCH_ATTR_DEFAULT_VIRTUAL_ROUTER_ID\x10(\x122\n" +
	".SWITCH_ATTR_DEFAULT_OVERRIDE_VIRTUAL_ROUTER_ID\x10)\x12$\n" +
	" SWITCH_ATTR_DEFAULT_1Q_BRIDGE_ID\x10*\x12\x1b\n" +
	"\x17SWITCH_ATTR_INGRESS_ACL\x10+\x12\x1a\n" +
	"\x16SWITCH_ATTR_EGRESS_ACL\x10,\x121\n" +
	"-SWITCH_ATTR_QOS_MAX_NUMBER_OF_TRAFFIC_CLASSES\x10-\x12B\n" +
	">SWITCH_ATTR_QOS_MAX_NUMBER_OF_SCHEDULER_GROUP_HIERARCHY_LEVELS\x10.\x12F\n" +
	"BSWITCH_ATTR_QOS_MAX_NUMBER_OF_SCHEDULER_GROUPS_PER_HIERARCHY_LEVEL\x10/\x12<\n" +
	"8SWITCH_ATTR_QOS_MAX_NUMBER_OF_CHILDS_PER_SCHEDULER_GROUP\x100\x12!\n" +
	"\x1dSWITCH_ATTR_TOTAL_BUFFER_SIZE\x101\x12'\n" +
	"#SWITCH_ATTR_INGRESS_BUFFER_POOL_NUM\x102\x12&\n" +
	"\"SWITCH_ATTR_EGRESS_BUFFER_POOL_NUM\x103\x12*\n" +
	"&SWITCH_ATTR_AVAILABLE_IPV4_ROUTE_ENTRY\x104\x12*\n" +
	"&SWITCH_ATTR_AVAILABLE_IPV6_ROUTE_ENTRY\x105\x12,\n" +
	"(SWITCH_ATTR_AVAILABLE_IPV4_NEXTHOP_ENTRY\x106\x12,\n" +
	"(SWITCH_ATTR_AVAILABLE_IPV6_NEXTHOP_ENTRY\x107\x12-\n" +
	")SWITCH_ATTR_AVAILABLE_IPV4_NEIGHBOR_ENTRY\x108\x12-\n" +
	")SWITCH_ATTR_AVAILABLE_IPV6_NEIGHBOR_ENTRY\x109\x12.\n" +
	"*SWITCH_ATTR_AVAILABLE_NEXT_HOP_GROUP_ENTRY\x10:\x125\n" +
	"1SWITCH_ATTR_AVAILABLE_NEXT_HOP_GROUP_MEMBER_ENTRY\x10;\x12#\n" +
	"\x1fSWITCH_ATTR_AVAILABLE_FDB_ENTRY\x10<\x12$\n" +
	" SWITCH_ATTR_AVAILABLE_L2MC_ENTRY\x10=\x12$\n" +
	" SWITCH_ATTR_AVAILABLE_IPMC_ENTRY\x10>\x12$\n" +
	" SWITCH_ATTR_AVAILABLE_SNAT_ENTRY\x10?\x12$\n" +
	" SWITCH_ATTR_AVAILABLE_DNAT_ENTRY\x10@\x12*\n" +
	"&SWITCH_ATTR_AVAILABLE_DOUBLE_NAT_ENTRY\x10A\x12#\n" +
	"\x1fSWITCH_ATTR_AVAILABLE_ACL_TABLE\x10B\x12)\n" +
	"%SWITCH_ATTR_AVAILABLE_ACL_TABLE_GROUP\x10C\x12&\n" +
	"\"SWITCH_ATTR_AVAILABLE_MY_SID_ENTRY\x10D\x12\"\n" +
	"\x1eSWITCH_ATTR_DEFAULT_TRAP_GROUP\x10E\x12\x19\n" +
	"\x15SWITCH_ATTR_ECMP_HASH\x10F\x12\x18\n" +
	"\x14SWITCH_ATTR_LAG_HASH\x10G\x12\x1c\n" +
	"\x18SWITCH_ATTR_RESTART_WARM\x10H\x12\x1c\n" +
	"\x18SWITCH_ATTR_WARM_RECOVER\x10I\x12\x1c\n" +
	"\x18SWITCH_ATTR_RESTART_TYPE\x10J\x12,\n" +
	"(SWITCH_ATTR_MIN_PLANNED_RESTART_INTERVAL\x10K\x12\x1f\n" +
	"\x1bSWITCH_ATTR_NV_STORAGE_SIZE\x10L\x12$\n" +
	" SWITCH_ATTR_MAX_ACL_ACTION_COUNT\x10M\x12#\n" +
	"\x1fSWITCH_ATTR_MAX_ACL_RANGE_COUNT\x10N\x12\x1e\n" +
	"\x1aSWITCH_ATTR_ACL_CAPABILITY\x10O\x12)\n" +
	"%SWITCH_ATTR_MCAST_SNOOPING_CAPABILITY\x10P\x12\x1e\n" +
	"\x1aSWITCH_ATTR_SWITCHING_MODE\x10Q\x12&\n" +
	"\"SWITCH_ATTR_BCAST_CPU_FLOOD_ENABLE\x10R\x12&\n" +
	"\"SWITCH_ATTR_MCAST_CPU_FLOOD_ENABLE\x10S\x12\x1f\n" +
	"\x1bSWITCH_ATTR_SRC_MAC_ADDRESS\x10T\x12%\n" +
	"!SWITCH_ATTR_MAX_LEARNED_ADDRESSES\x10U\x12\x1e\n" +
	"\x1aSWITCH_ATTR_FDB_AGING_TIME\x10V\x12.\n" +
	"*SWITCH_ATTR_FDB_UNICAST_MISS_PACKET_ACTION\x10W\x120\n" +
	",SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION\x10X\x120\n" +
	",SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION\x10Y\x12+\n" +
	"'SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM\x10Z\x12&\n" +
	"\"SWITCH_ATTR_ECMP_DEFAULT_HASH_SEED\x10[\x12(\n" +
	"$SWITCH_ATTR_ECMP_DEFAULT_HASH_OFFSET\x10\\\x12+\n" +
	"'SWITCH_ATTR_ECMP_DEFAULT_SYMMETRIC_HASH\x10]\x12\x1e\n" +
	"\x1aSWITCH_ATTR_ECMP_HASH_IPV4\x10^\x12&\n" +
	"\"SWITCH_ATTR_ECMP_HASH_IPV4_IN_IPV4\x10_\x12\x1e\n" +
	"\x1aSWITCH_ATTR_ECMP_HASH_IPV6\x10`\x12*\n" +
	"&SWITCH_ATTR_LAG_DEFAULT_HASH_ALGORITHM\x10a\x12%\n" +
	"!SWITCH_ATTR_LAG_DEFAULT_HASH_SEED\x10b\x12'\n" +
	"#SWITCH_ATTR_LAG_DEFAULT_HASH_OFFSET\x10c\x12*\n" +
	"&SWITCH_ATTR_LAG_DEFAULT_SYMMETRIC_HASH\x10d\x12\x1d\n" +
	"\x19SWITCH_ATTR_LAG_HASH_IPV4\x10e\x12%\n" +
	"!SWITCH_ATTR_LAG_HASH_IPV4_IN_IPV4\x10f\x12\x1d\n" +
	"\x19SWITCH_ATTR_LAG_HASH_IPV6\x10g\x12(\n" +
	"$SWITCH_ATTR_COUNTER_REFRESH_INTERVAL\x10h\x12\x1e\n" +
	"\x1aSWITCH_ATTR_QOS_DEFAULT_TC\x10i\x12#\n" +
	"\x1fSWITCH_ATTR_QOS_DOT1P_TO_TC_MAP\x10j\x12&\n" +
	"\"SWITCH_ATTR_QOS_DOT1P_TO_COLOR_MAP\x10k\x12\"\n" +
	"\x1eSWITCH_ATTR_QOS_DSCP_TO_TC_MAP\x10l\x12%\n" +
	"!SWITCH_ATTR_QOS_DSCP_TO_COLOR_MAP\x10m\x12#\n" +
	"\x1fSWITCH_ATTR_QOS_TC_TO_QUEUE_MAP\x10n\x12-\n" +
	")SWITCH_ATTR_QOS_TC_AND_COLOR_TO_DOT1P_MAP\x10o\x12,\n" +
	"(SWITCH_ATTR_QOS_TC_AND_COLOR_TO_DSCP_MAP\x10p\x12#\n" +
	"\x1fSWITCH_ATTR_SWITCH_SHELL_ENABLE\x10q\x12!\n" +
	"\x1dSWITCH_ATTR_SWITCH_PROFILE_ID\x10r\x12$\n" +
	" SWITCH_ATTR_SWITCH_HARDWARE_INFO\x10s\x12\"\n" +
	"\x1eSWITCH_ATTR_FIRMWARE_PATH_NAME\x10t\x12\x1b\n" +
	"\x17SWITCH_ATTR_INIT_SWITCH\x10u\x12*\n" +
	"&SWITCH_ATTR_SWITCH_STATE_CHANGE_NOTIFY\x10v\x12.\n" +
	"*SWITCH_ATTR_SWITCH_SHUTDOWN_REQUEST_NOTIFY\x10w\x12 \n" +
	"\x1cSWITCH_ATTR_FDB_EVENT_NOTIFY\x10x\x12(\n" +
	"$SWITCH_ATTR_PORT_STATE_CHANGE_NOTIFY\x10y\x12#\n" +
	"\x1fSWITCH_ATTR_PACKET_EVENT_NOTIFY\x10z\x12\x1f\n" +
	"\x1bSWITCH_ATTR_FAST_API_ENABLE\x10{\x12\x19\n" +
	"\x15SWITCH_ATTR_MIRROR_TC\x10|\x12!\n" +
	"\x1dSWITCH_ATTR_ACL_STAGE_INGRESS\x10}\x12 \n" +
	"\x1cSWITCH_ATTR_ACL_STAGE_EGRESS\x10~\x12\"\n" +
	"\x1eSWITCH_ATTR_SRV6_MAX_SID_DEPTH\x10\x7f\x12\x1e\n" +
	"\x19SWITCH_ATTR_SRV6_TLV_TYPE\x10\x80\x01\x12(\n" +
	"#SWITCH_ATTR_QOS_NUM_LOSSLESS_QUEUES\x10\x81\x01\x12*\n" +
	"%SWITCH_ATTR_QUEUE_PFC_DEADLOCK_NOTIFY\x10\x82\x01\x12&\n" +
	"!SWITCH_ATTR_PFC_DLR_PACKET_ACTION\x10\x83\x01\x12*\n" +
	"%SWITCH_ATTR_PFC_TC_DLD_INTERVAL_RANGE\x10\x84\x01\x12$\n" +
	"\x1fSWITCH_ATTR_PFC_TC_DLD_INTERVAL\x10\x85\x01\x12*\n" +
	"%SWITCH_ATTR_PFC_TC_DLR_INTERVAL_RANGE\x10\x86\x01\x12$\n" +
	"\x1fSWITCH_ATTR_PFC_TC_DLR_INTERVAL\x10\x87\x01\x120\n" +
	"+SWITCH_ATTR_SUPPORTED_PROTECTED_OBJECT_TYPE\x10\x88\x01\x12 \n" +
	"\x1bSWITCH_ATTR_TPID_OUTER_VLAN\x10\x89\x01\x12 \n" +
	"\x1bSWITCH_ATTR_TPID_INNER_VLAN\x10\x8a\x01\x12!\n" +
	"\x1cSWITCH_ATTR_CRC_CHECK_ENABLE\x10\x8b\x01\x12)\n" +
	"$SWITCH_ATTR_CRC_RECALCULATION_ENABLE\x10\x8c\x01\x120\n" +
	"+SWITCH_ATTR_BFD_SESSION_STATE_CHANGE_NOTIFY\x10\x8d\x01\x12&\n" +
	"!SWITCH_ATTR_NUMBER_OF_BFD_SESSION\x10\x8e\x01\x12 \n" +
	"\x1bSWITCH_ATTR_MAX_BFD_SESSION\x10\x8f\x01\x128\n" +
	"3SWITCH_ATTR_SUPPORTED_IPV4_BFD_SESSION_OFFLOAD_TYPE\x10\x90\x01\x128\n" +
	"3SWITCH_ATTR_SUPPORTED_IPV6_BFD_SESSION_OFFLOAD_TYPE\x10\x91\x01\x12\x1b\n" +
	"\x16SWITCH_ATTR_MIN_BFD_RX\x10\x92\x01\x12\x1b\n" +
	"\x16SWITCH_ATTR_MIN_BFD_TX\x10\x93\x01\x12)\n" +
	"$SWITCH_ATTR_ECN_ECT_THRESHOLD_ENABLE\x10\x94\x01\x12)\n" +
	"$SWITCH_ATTR_VXLAN_DEFAULT_ROUTER_MAC\x10\x95\x01\x12#\n" +
	"\x1eSWITCH_ATTR_VXLAN_DEFAULT_PORT\x10\x96\x01\x12#\n" +
	"\x1eSWITCH_ATTR_MAX_MIRROR_SESSION\x10\x97\x01\x12+\n" +
	"&SWITCH_ATTR_MAX_SAMPLED_MIRROR_SESSION\x10\x98\x01\x12.\n" +
	")SWITCH_ATTR_SUPPORTED_EXTENDED_STATS_MODE\x10\x99\x01\x12-\n" +
	"(SWITCH_ATTR_UNINIT_DATA_PLANE_ON_REMOVAL\x10\x9a\x01\x12\x1e\n" +
	"\x19SWITCH_ATTR_TAM_OBJECT_ID\x10\x9b\x01\x12!\n" +
	"\x1cSWITCH_ATTR_TAM_EVENT_NOTIFY\x10\x9c\x01\x12+\n" +
	"&SWITCH_ATTR_SUPPORTED_OBJECT_TYPE_LIST\x10\x9d\x01\x12\x1d\n" +
	"\x18SWITCH_ATTR_PRE_SHUTDOWN\x10\x9e\x01\x12+\n" +
	"&SWITCH_ATTR_NAT_ZONE_COUNTER_OBJECT_ID\x10\x9f\x01\x12\x1b\n" +
	"\x16SWITCH_ATTR_NAT_ENABLE\x10\xa0\x01\x12$\n" +
	"\x1fSWITCH_ATTR_HARDWARE_ACCESS_BUS\x10\xa1\x01\x12!\n" +
	"\x1cSWITCH_ATTR_PLATFROM_CONTEXT\x10\xa2\x01\x12\x1e\n" +
	"\x19SWITCH_ATTR_REGISTER_READ\x10\xa3\x01\x12\x1f\n" +
	"\x1aSWITCH_ATTR_REGISTER_WRITE\x10\xa4\x01\x12,\n" +
	"'SWITCH_ATTR_FIRMWARE_DOWNLOAD_BROADCAST\x10\xa5\x01\x12%\n" +
	" SWITCH_ATTR_FIRMWARE_LOAD_METHOD\x10\xa6\x01\x12#\n" +
	"\x1eSWITCH_ATTR_FIRMWARE_LOAD_TYPE\x10\xa7\x01\x12*\n" +
	"%SWITCH_ATTR_FIRMWARE_DOWNLOAD_EXECUTE\x10\xa8\x01\x12(\n" +
	"#SWITCH_ATTR_FIRMWARE_BROADCAST_STOP\x10\xa9\x01\x120\n" +
	"+SWITCH_ATTR_FIRMWARE_VERIFY_AND_INIT_SWITCH\x10\xaa\x01\x12 \n" +
	"\x1bSWITCH_ATTR_FIRMWARE_STATUS\x10\xab\x01\x12'\n" +
	"\"SWITCH_ATTR_FIRMWARE_MAJOR_VERSION\x10\xac\x01\x12'\n" +
	"\"SWITCH_ATTR_FIRMWARE_MINOR_VERSION\x10\xad\x01\x12$\n" +
	"\x1fSWITCH_ATTR_PORT_CONNECTOR_LIST\x10\xae\x01\x12F\n" +
	"ASWITCH_ATTR_PROPOGATE_PORT_STATE_FROM_LINE_TO_SYSTEM_PORT_SUPPORT\x10\xaf\x01\x12\x15\n" +
	"\x10SWITCH_ATTR_TYPE\x10\xb0\x01\x12#\n" +
	"\x1eSWITCH_ATTR_MACSEC_OBJECT_LIST\x10\xb1\x01\x12'\n" +
	"\"SWITCH_ATTR_QOS_MPLS_EXP_TO_TC_MAP\x10\xb2\x01\x12*\n" +
	"%SWITCH_ATTR_QOS_MPLS_EXP_TO_COLOR_MAP\x10\xb3\x01\x121\n" +
	",SWITCH_ATTR_QOS_TC_AND_COLOR_TO_MPLS_EXP_MAP\x10\xb4\x01\x12\x1a\n" +
	"\x15SWITCH_ATTR_SWITCH_ID\x10\xb5\x01\x12!\n" +
	"\x1cSWITCH_ATTR_MAX_SYSTEM_CORES\x10\xb6\x01\x12(\n" +
	"#SWITCH_ATTR_SYSTEM_PORT_CONFIG_LIST\x10\xb7\x01\x12'\n" +
	"\"SWITCH_ATTR_NUMBER_OF_SYSTEM_PORTS\x10\xb8\x01\x12!\n" +
	"\x1cSWITCH_ATTR_SYSTEM_PORT_LIST\x10\xb9\x01\x12'\n" +
	"\"SWITCH_ATTR_NUMBER_OF_FABRIC_PORTS\x10\xba\x01\x12!\n" +
	"\x1cSWITCH_ATTR_FABRIC_PORT_LIST\x10\xbb\x01\x12,\n" +
	"'SWITCH_ATTR_PACKET_DMA_MEMORY_POOL_SIZE\x10\xbc\x01\x12%\n" +
	" SWITCH_ATTR_FAILOVER_CONFIG_MODE\x10\xbd\x01\x12(\n" +
	"#SWITCH_ATTR_SUPPORTED_FAILOVER_MODE\x10\xbe\x01\x12$\n" +
	"\x1fSWITCH_ATTR_TUNNEL_OBJECTS_LIST\x10\xbf\x01\x126\n" +
	"1SWITCH_ATTR_PACKET_AVAILABLE_DMA_MEMORY_POOL_SIZE\x10\xc0\x01\x12 \n" +
	"\x1bSWITCH_ATTR_PRE_INGRESS_ACL\x10\xc1\x01\x12&\n" +
	"!SWITCH_ATTR_AVAILABLE_SNAPT_ENTRY\x10\xc2\x01\x12&\n" +
	"!SWITCH_ATTR_AVAILABLE_DNAPT_ENTRY\x10\xc3\x01\x12,\n" +
	"'SWITCH_ATTR_AVAILABLE_DOUBLE_NAPT_ENTRY\x10\xc4\x01\x12%\n" +
	" SWITCH_ATTR_SLAVE_MDIO_ADDR_LIST\x10\xc5\x01\x12.\n" +
	")SWITCH_ATTR_MY_MAC_TABLE_MINIMUM_PRIORITY\x10\xc6\x01\x12.\n" +
	")SWITCH_ATTR_MY_MAC_TABLE_MAXIMUM_PRIORITY\x10\xc7\x01\x12\x1c\n" +
	"\x17SWITCH_ATTR_MY_MAC_LIST\x10\xc8\x01\x12)\n" +
	"$SWITCH_ATTR_INSTALLED_MY_MAC_ENTRIES\x10\xc9\x01\x12)\n" +
	"$SWITCH_ATTR_AVAILABLE_MY_MAC_ENTRIES\x10\xca\x01\x121\n" +
	",SWITCH_ATTR_MAX_NUMBER_OF_FORWARDING_CLASSES\x10\xcb\x01\x121\n" +
	",SWITCH_ATTR_QOS_DSCP_TO_FORWARDING_CLASS_MAP\x10\xcc\x01\x125\n" +
	"0SWITCH_ATTR_QOS_MPLS_EXP_TO_FORWARDING_CLASS_MAP\x10\xcd\x01\x12 \n" +
	"\x1bSWITCH_ATTR_IPSEC_OBJECT_ID\x10\xce\x01\x12\"\n" +
	"\x1dSWITCH_ATTR_IPSEC_SA_TAG_TPID\x10\xcf\x01\x12.\n" +
	")SWITCH_ATTR_IPSEC_SA_STATUS_CHANGE_NOTIFY\x10\xd0\x01\x12!\n" +
	"\x1cSWITCH_ATTR_NAT_EVENT_NOTIFY\x10\xd1\x01\x12&\n" +
	"!SWITCH_ATTR_MAX_ECMP_MEMBER_COUNT\x10\xd2\x01\x12\"\n" +
	"\x1dSWITCH_ATTR_ECMP_MEMBER_COUNT\x10\xd3\x01\x12\x1c\n" +
	"\x17SWITCH_ATTR_ARS_PROFILE\x10\xd4\x01\x12'\n" +
	"\"SWITCH_ATTR_ACL_STAGE_POST_INGRESS\x10\xd5\x01\x12\x1a\n" +
	"\x15SWITCH_ATTR_CREDIT_WD\x10\xd6\x01\x12 \n" +
	"\x1bSWITCH_ATTR_CREDIT_WD_TIMER\x10\xd7\x01\x12\x1f\n" +
	"\x1aSWITCH_ATTR_SWITCH_ISOLATE\x10\xd8\x01\x12/\n" +
	"*SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE\x10\xd9\x01\x124\n" +
	"/SWITCH_ATTR_SWITCH_ASIC_SDK_HEALTH_EVENT_NOTIFY\x10\xda\x01\x12:\n" +
	"5SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY\x10\xdb\x01\x12<\n" +
	"7SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY\x10\xdc\x01\x12;\n" +
	"6SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY\x10\xdd\x01\x12\x1f\n" +
	"\x1aSWITCH_ATTR_ACL_CHAIN_LIST\x10\xde\x01\x12*\n" +
	"%SWITCH_ATTR_PORT_HOST_TX_READY_NOTIFY\x10\xdf\x01\x129\n" +
	"4SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MINIMUM_PRIORITY\x10\xe0\x01\x129\n" +
	"4SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MAXIMUM_PRIORITY\x10\xe1\x01\x12+\n" +
	"&SWITCH_ATTR_TWAMP_SESSION_EVENT_NOTIFY\x10\xe2\x01\x12(\n" +
	"#SWITCH_ATTR_AVAILABLE_TWAMP_SESSION\x10\xe3\x01\x12\"\n" +
	"\x1dSWITCH_ATTR_MAX_TWAMP_SESSION\x10\xe4\x01\x129\n" +
	"4SWITCH_ATTR_AVAILABLE_IP_NEXT_HOP_GROUP_MEMBER_ENTRY\x10\xe5\x01\x12&\n" +
	"!SWITCH_ATTR_AVAILABLE_SYSTEM_VOQS\x10\xe6\x01\x12&\n" +
	"!SWITCH_ATTR_ACL_STAGE_PRE_INGRESS\x10\xe7\x01\x12 \n" +
	"\x1bSWITCH_ATTR_POE_DEVICE_LIST\x10\xe8\x01\x126\n" +
	"1SWITCH_ATTR_ICMP_ECHO_SESSION_STATE_CHANGE_NOTIFY\x10\xe9\x01\x12,\n" +
	...
	"\x1fSWITCH_ATTR_DISABLE_VLAN_CHECKS\x10\xee\x01\x12,\n" +
	"'SWITCH_ATTR_DISABLE_INGRESS_VLAN_CHECKS\x10\xef\x01\x12+\n" +
	"&SWITCH_ATTR_DISABLE_EGRESS_VLAN_CHECKS\x10\xf0\x01*\x93\x05\n" +
	"\x10SwitchTunnelAttr\x12\"\n" +
	"\x1eSWITCH_TUNNEL_ATTR_UNSPECIFIED\x10\x00\x12\"\n" +
	"\x1eSWITCH_TUNNEL_ATTR_TUNNEL_TYPE\x10\x01\x12-\n" +
	")SWITCH_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION\x10\x02\x12,\n" +
	"(SWITCH_TUNNEL_ATTR_TUNNEL_ENCAP_ECN_MODE\x10\x03\x12$\n" +
	" SWITCH_TUNNEL_ATTR_ENCAP_MAPPERS\x10\x04\x12,\n" +
	"(SWITCH_TUNNEL_ATTR_TUNNEL_DECAP_ECN_MODE\x10\x05\x12$\n" +
	" SWITCH_TUNNEL_ATTR_DECAP_MAPPERS\x10\x06\x122\n" +
	".SWITCH_TUNNEL_ATTR_TUNNEL_VXLAN_UDP_SPORT_MODE\x10\a\x12&\n" +
	"\"SWITCH_TUNNEL_ATTR_VXLAN_UDP_SPORT\x10\b\x12+\n" +
	"'SWITCH_TUNNEL_ATTR_VXLAN_UDP_SPORT_MASK\x10\t\x129\n" +
	"5SWITCH_TUNNEL_ATTR_ENCAP_QOS_TC_AND_COLOR_TO_DSCP_MAP\x10\n" +
	"\x120\n" +
	",SWITCH_TUNNEL_ATTR_ENCAP_QOS_TC_TO_QUEUE_MAP\x10\v\x12/\n" +
	"+SWITCH_TUNNEL_ATTR_DECAP_QOS_DSCP_TO_TC_MAP\x10\f\x129\n" +
	"5SWITCH_TUNNEL_ATTR_DECAP_QOS_TC_TO_PRIORITY_GROUP_MAP\x10\r2\xd7\x13\n" +
	"\x06Switch\x12i\n" +
	"\fCreateSwitch\x12*.lemming.dataplane.sai.CreateSwitchRequest\x1a+.lemming.dataplane.sai.CreateSwitchResponse\"\x00\x12i\n" +
	"\fRemoveSwitch\x12*.lemming.dataplane.sai.RemoveSwitchRequest\x1a+.lemming.dataplane.sai.RemoveSwitchResponse\"\x00\x12{\n" +
	"\x12SetSwitchAttribute\x120.lemming.dataplane.sai.SetSwitchAttributeRequest\x1a1.lemming.dataplane.sai.SetSwitchAttributeResponse\"\x00\x12\x9e\x01\n" +
	"\x1dSwitchStateChangeNotification\x12;.lemming.dataplane.sai.SwitchStateChangeNotificationRequest\x1a<.lemming.dataplane.sai.SwitchStateChangeNotificationResponse\"\x000\x01\x12\xaa\x01\n" +
	"!SwitchShutdownRequestNotification\x12?.lemming.dataplane.sai.SwitchShutdownRequestNotificationRequest\x1a@.lemming.dataplane.sai.SwitchShutdownRequestNotificationResponse\"\x000\x01\x12\x83\x01\n" +
	"\x14FdbEventNotification\x122.lemming.dataplane.sai.FdbEventNotificationRequest\x1a3.lemming.dataplane.sai.FdbEventNotificationResponse\"\x000\x01\x12\x98\x01\n" +
	"\x1bPortStateChangeNotification\x129.lemming.dataplane.sai.PortStateChangeNotificationRequest\x1a:.lemming.dataplane.sai.PortStateChangeNotificationResponse\"\x000\x01\x12\x8c\x01\n" +
	"\x17PacketEventNotification\x125.lemming.dataplane.sai.PacketEventNotificationRequest\x1a6.lemming.dataplane.sai.PacketEventNotificationResponse\"\x000\x01\x12\x9b\x01\n" +
	"\x1cQueuePfcDeadlockNotification\x12:.lemming.dataplane.sai.QueuePfcDeadlockNotificationRequest\x1a;.lemming.dataplane.sai.QueuePfcDeadlockNotificationResponse\"\x000\x01\x12\xaa\x01\n" +
	"!BfdSessionStateChangeNotification\x12?.lemming.dataplane.sai.BfdSessionStateChangeNotificationRequest\x1a@.lemming.dataplane.sai.BfdSessionStateChangeNotificationResponse\"\x000\x01\x12\x83\x01\n" +
	"\x14TamEventNotification\x122.lemming.dataplane.sai.TamEventNotificationRequest\x1a3.lemming.dataplane.sai.TamEventNotificationResponse\"\x000\x01\x12\xa2\x01\n" +
	"\x1fIpsecSaStatusChangeNotification\x12=.lemming.dataplane.sai.IpsecSaStatusChangeNotificationRequest\x1a<.lemming.dataplane.sai.IpsecSaStatusNotificationDataResponse\"\x000\x01\x12{\n" +
	"\x12GetSwitchAttribute\x120.lemming.dataplane.sai.GetSwitchAttributeRequest\x1a1.lemming.dataplane.sai.GetSwitchAttributeResponse\"\x00\x12o\n" +
	"\x0eGetSwitchStats\x12,.lemming.dataplane.sai.GetSwitchStatsRequest\x1a-.lemming.dataplane.sai.GetSwitchStatsResponse\"\x00\x12{\n" +
	"\x12CreateSwitchTunnel\x120.lemming.dataplane.sai.CreateSwitchTunnelRequest\x1a1.lemming.dataplane.sai.CreateSwitchTunnelResponse\"\x00\x12{\n" +
	"\x12RemoveSwitchTunnel\x120.lemming.dataplane.sai.RemoveSwitchTunnelRequest\x1a1.lemming.dataplane.sai.RemoveSwitchTunnelResponse\"\x00\x12\x8d\x01\n" +
	"\x18SetSwitchTunnelAttribute\x126.lemming.dataplane.sai.SetSwitchTunnelAttributeRequest\x1a7.lemming.dataplane.sai.SetSwitchTunnelAttributeResponse\"\x00\x12\x8d\x01\n" +
	"\x18GetSwitchTunnelAttribute\x126.lemming.dataplane.sai.GetSwitchTunnelAttributeRequest\x1a7.lemming.dataplane.sai.GetSwitchTunnelAttributeResponse\"\x00B3Z1github.com/openconfig/lemming/dataplane/proto/saib\x06proto3"

var (
	file_dataplane_proto_sai_switch_proto_rawDescOnce sync.Once
	file_dataplane_proto_sai_switch_proto_rawDescData []byte
)

func file_dataplane_proto_sai_switch_proto_rawDescGZIP() []byte {
	file_dataplane_proto_sai_switch_proto_rawDescOnce.Do(func() {
		file_dataplane_proto_sai_switch_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dataplane_proto_sai_switch_proto_rawDesc), len(file_dataplane_proto_sai_switch_proto_rawDesc)))
	})
...
var file_dataplane_proto_sai_switch_proto_goTypes = []any{
	...
	(SwitchHostifOperStatusUpdateMode)(0),             // 48: lemming.dataplane.sai.SwitchHostifOperStatusUpdateMode
	(SwitchAsicSdkHealthCategory)(0),                  // 49: lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	(StatsCountMode)(0),                               // 50: lemming.dataplane.sai.StatsCountMode
	(*SwitchAttribute)(nil),                           // 51: lemming.dataplane.sai.SwitchAttribute
	(SwitchOperStatus)(0),                             // 52: lemming.dataplane.sai.SwitchOperStatus
	(*FdbEventNotificationData)(nil),                  // 53: lemming.dataplane.sai.FdbEventNotificationData
	(*PortOperStatusNotification)(nil),                // 54: lemming.dataplane.sai.PortOperStatusNotification
	(*HostifPacketAttribute)(nil),                     // 55: lemming.dataplane.sai.HostifPacketAttribute
	(*QueueDeadlockNotificationData)(nil),             // 56: lemming.dataplane.sai.QueueDeadlockNotificationData
	(*BfdSessionStateChangeNotificationData)(nil),     // 57: lemming.dataplane.sai.BfdSessionStateChangeNotificationData
	(*TamEventActionAttribute)(nil),                   // 58: lemming.dataplane.sai.TamEventActionAttribute
	(*IpsecSaStatusNotificationData)(nil),             // 59: lemming.dataplane.sai.IpsecSaStatusNotificationData
	(SwitchStat)(0),                                   // 60: lemming.dataplane.sai.SwitchStat
	(TunnelType)(0),                                   // 61: lemming.dataplane.sai.TunnelType
	(TunnelEncapEcnMode)(0),                           // 62: lemming.dataplane.sai.TunnelEncapEcnMode
	(TunnelDecapEcnMode)(0),                           // 63: lemming.dataplane.sai.TunnelDecapEcnMode
	(TunnelVxlanUdpSportMode)(0),                      // 64: lemming.dataplane.sai.TunnelVxlanUdpSportMode
	(*SwitchTunnelAttribute)(nil),                     // 65: lemming.dataplane.sai.SwitchTunnelAttribute
}
var file_dataplane_proto_sai_switch_proto_depIdxs = []int32{
	...
	48, // 15: lemming.dataplane.sai.CreateSwitchRequest.hostif_oper_status_update_mode:type_name -> lemming.dataplane.sai.SwitchHostifOperStatusUpdateMode
	49, // 16: lemming.dataplane.sai.CreateSwitchRequest.reg_fatal_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	49, // 17: lemming.dataplane.sai.CreateSwitchRequest.reg_warning_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	49, // 18: lemming.dataplane.sai.CreateSwitchRequest.reg_notice_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	50, // 19: lemming.dataplane.sai.CreateSwitchRequest.stats_count_mode:type_name -> lemming.dataplane.sai.StatsCountMode
	38, // 20: lemming.dataplane.sai.SetSwitchAttributeRequest.switching_mode:type_name -> lemming.dataplane.sai.SwitchSwitchingMode
	39, // 21: lemming.dataplane.sai.SetSwitchAttributeRequest.fdb_unicast_miss_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	39, // 22: lemming.dataplane.sai.SetSwitchAttributeRequest.fdb_broadcast_miss_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	39, // 23: lemming.dataplane.sai.SetSwitchAttributeRequest.fdb_multicast_miss_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	40, // 24: lemming.dataplane.sai.SetSwitchAttributeRequest.ecmp_default_hash_algorithm:type_name -> lemming.dataplane.sai.HashAlgorithm
	40, // 25: lemming.dataplane.sai.SetSwitchAttributeRequest.lag_default_hash_algorithm:type_name -> lemming.dataplane.sai.HashAlgorithm
	39, // 26: lemming.dataplane.sai.SetSwitchAttributeRequest.pfc_dlr_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	41, // 27: lemming.dataplane.sai.SetSwitchAttributeRequest.pfc_tc_dld_interval:type_name -> lemming.dataplane.sai.UintMap
	41, // 28: lemming.dataplane.sai.SetSwitchAttributeRequest.pfc_tc_dlr_interval:type_name -> lemming.dataplane.sai.UintMap
	47, // 29: lemming.dataplane.sai.SetSwitchAttributeRequest.failover_config_mode:type_name -> lemming.dataplane.sai.SwitchFailoverConfigMode
	48, // 30: lemming.dataplane.sai.SetSwitchAttributeRequest.hostif_oper_status_update_mode:type_name -> lemming.dataplane.sai.SwitchHostifOperStatusUpdateMode
	49, // 31: lemming.dataplane.sai.SetSwitchAttributeRequest.reg_fatal_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	49, // 32: lemming.dataplane.sai.SetSwitchAttributeRequest.reg_warning_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	49, // 33: lemming.dataplane.sai.SetSwitchAttributeRequest.reg_notice_switch_asic_sdk_health_category:type_name -> lemming.dataplane.sai.SwitchAsicSdkHealthCategory
	50, // 34: lemming.dataplane.sai.SetSwitchAttributeRequest.stats_count_mode:type_name -> lemming.dataplane.sai.StatsCountMode
	0,  // 35: lemming.dataplane.sai.GetSwitchAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.SwitchAttr
	51, // 36: lemming.dataplane.sai.GetSwitchAttributeResponse.attr:type_name -> lemming.dataplane.sai.SwitchAttribute
	52, // 37: lemming.dataplane.sai.SwitchStateChangeNotificationResponse.switch_oper_status:type_name -> lemming.dataplane.sai.SwitchOperStatus
	53, // 38: lemming.dataplane.sai.FdbEventNotificationResponse.data:type_name -> lemming.dataplane.sai.FdbEventNotificationData
	54, // 39: lemming.dataplane.sai.PortStateChangeNotificationResponse.data:type_name -> lemming.dataplane.sai.PortOperStatusNotification
	55, // 40: lemming.dataplane.sai.PacketEventNotificationResponse.attrs:type_name -> lemming.dataplane.sai.HostifPacketAttribute
	56, // 41: lemming.dataplane.sai.QueuePfcDeadlockNotificationResponse.data:type_name -> lemming.dataplane.sai.QueueDeadlockNotificationData
	57, // 42: lemming.dataplane.sai.BfdSessionStateChangeNotificationResponse.data:type_name -> lemming.dataplane.sai.BfdSessionStateChangeNotificationData
	58, // 43: lemming.dataplane.sai.TamEventNotificationResponse.attrs:type_name -> lemming.dataplane.sai.TamEventActionAttribute
	59, // 44: lemming.dataplane.sai.IpsecSaStatusNotificationDataResponse.data:type_name -> lemming.dataplane.sai.IpsecSaStatusNotificationData
	60, // 45: lemming.dataplane.sai.GetSwitchStatsRequest.counter_ids:type_name -> lemming.dataplane.sai.SwitchStat
	61, // 46: lemming.dataplane.sai.CreateSwitchTunnelRequest.tunnel_type:type_name -> lemming.dataplane.sai.TunnelType
	39, // 47: lemming.dataplane.sai.CreateSwitchTunnelRequest.loopback_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	62, // 48: lemming.dataplane.sai.CreateSwitchTunnelRequest.tunnel_encap_ecn_mode:type_name -> lemming.dataplane.sai.TunnelEncapEcnMode
	63, // 49: lemming.dataplane.sai.CreateSwitchTunnelRequest.tunnel_decap_ecn_mode:type_name -> lemming.dataplane.sai.TunnelDecapEcnMode
	64, // 50: lemming.dataplane.sai.CreateSwitchTunnelRequest.tunnel_vxlan_udp_sport_mode:type_name -> lemming.dataplane.sai.TunnelVxlanUdpSportMode
	39, // 51: lemming.dataplane.sai.SetSwitchTunnelAttributeRequest.loopback_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	64, // 52: lemming.dataplane.sai.SetSwitchTunnelAttributeRequest.tunnel_vxlan_udp_sport_mode:type_name -> lemming.dataplane.sai.TunnelVxlanUdpSportMode
	1,  // 53: lemming.dataplane.sai.GetSwitchTunnelAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.SwitchTunnelAttr
	65, // 54: lemming.dataplane.sai.GetSwitchTunnelAttributeResponse.attr:type_name -> lemming.dataplane.sai.SwitchTunnelAttribute
	2,  // 55: lemming.dataplane.sai.Switch.CreateSwitch:input_type -> lemming.dataplane.sai.CreateSwitchRequest
	4,  // 56: lemming.dataplane.sai.Switch.RemoveSwitch:input_type -> lemming.dataplane.sai.RemoveSwitchRequest
	6,  // 57: lemming.dataplane.sai.Switch.SetSwitchAttribute:input_type -> lemming.dataplane.sai.SetSwitchAttributeRequest
	10, // 58: lemming.dataplane.sai.Switch.SwitchStateChangeNotification:input_type -> lemming.dataplane.sai.SwitchStateChangeNotificationRequest
	12, // 59: lemming.dataplane.sai.Switch.SwitchShutdownRequestNotification:input_type -> lemming.dataplane.sai.SwitchShutdownRequestNotificationRequest
	14, // 60: lemming.dataplane.sai.Switch.FdbEventNotification:input_type -> lemming.dataplane.sai.FdbEventNotificationRequest
	16, // 61: lemming.dataplane.sai.Switch.PortStateChangeNotification:input_type -> lemming.dataplane.sai.PortStateChangeNotificationRequest
	18, // 62: lemming.dataplane.sai.Switch.PacketEventNotification:input_type -> lemming.dataplane.sai.PacketEventNotificationRequest
	20, // 63: lemming.dataplane.sai.Switch.QueuePfcDeadlockNotification:input_type -> lemming.dataplane.sai.QueuePfcDeadlockNotificationRequest
	22, // 64: lemming.dataplane.sai.Switch.BfdSessionStateChangeNotification:input_type -> lemming.dataplane.sai.BfdSessionStateChangeNotificationRequest
	24, // 65: lemming.dataplane.sai.Switch.TamEventNotification:input_type -> lemming.dataplane.sai.TamEventNotificationRequest
	26, // 66: lemming.dataplane.sai.Switch.IpsecSaStatusChangeNotification:input_type -> lemming.dataplane.sai.IpsecSaStatusChangeNotificationRequest
	8,  // 67: lemming.dataplane.sai.Switch.GetSwitchAttribute:input_type -> lemming.dataplane.sai.GetSwitchAttributeRequest
	28, // 68: lemming.dataplane.sai.Switch.GetSwitchStats:input_type -> lemming.dataplane.sai.GetSwitchStatsRequest
	30, // 69: lemming.dataplane.sai.Switch.CreateSwitchTunnel:input_type -> lemming.dataplane.sai.CreateSwitchTunnelRequest
	32, // 70: lemming.dataplane.sai.Switch.RemoveSwitchTunnel:input_type -> lemming.dataplane.sai.RemoveSwitchTunnelRequest
	34, // 71: lemming.dataplane.sai.Switch.SetSwitchTunnelAttribute:input_type -> lemming.dataplane.sai.SetSwitchTunnelAttributeRequest
	36, // 72: lemming.dataplane.sai.Switch.GetSwitchTunnelAttribute:input_type -> lemming.dataplane.sai.GetSwitchTunnelAttributeRequest
	3,  // 73: lemming.dataplane.sai.Switch.CreateSwitch:output_type -> lemming.dataplane.sai.CreateSwitchResponse
	5,  // 74: lemming.dataplane.sai.Switch.RemoveSwitch:output_type -> lemming.dataplane.sai.RemoveSwitchResponse
	7,  // 75: lemming.dataplane.sai.Switch.SetSwitchAttribute:output_type -> lemming.dataplane.sai.SetSwitchAttributeResponse
	11, // 76: lemming.dataplane.sai.Switch.SwitchStateChangeNotification:output_type -> lemming.dataplane.sai.SwitchStateChangeNotificationResponse
	13, // 77: lemming.dataplane.sai.Switch.SwitchShutdownRequestNotification:output_type -> lemming.dataplane.sai.SwitchShutdownRequestNotificationResponse
	15, // 78: lemming.dataplane.sai.Switch.FdbEventNotification:output_type -> lemming.dataplane.sai.FdbEventNotificationResponse
	17, // 79: lemming.dataplane.sai.Switch.PortStateChangeNotification:output_type -> lemming.dataplane.sai.PortStateChangeNotificationResponse
	19, // 80: lemming.dataplane.sai.Switch.PacketEventNotification:output_type -> lemming.dataplane.sai.PacketEventNotificationResponse
	21, // 81: lemming.dataplane.sai.Switch.QueuePfcDeadlockNotification:output_type -> lemming.dataplane.sai.QueuePfcDeadlockNotificationResponse
	23, // 82: lemming.dataplane.sai.Switch.BfdSessionStateChangeNotification:output_type -> lemming.dataplane.sai.BfdSessionStateChangeNotificationResponse
	25, // 83: lemming.dataplane.sai.Switch.TamEventNotification:output_type -> lemming.dataplane.sai.TamEventNotificationResponse
	27, // 84: lemming.dataplane.sai.Switch.IpsecSaStatusChangeNotification:output_type -> lemming.dataplane.sai.IpsecSaStatusNotificationDataResponse
	9,  // 85: lemming.dataplane.sai.Switch.GetSwitchAttribute:output_type -> lemming.dataplane.sai.GetSwitchAttributeResponse
	29, // 86: lemming.dataplane.sai.Switch.GetSwitchStats:output_type -> lemming.dataplane.sai.GetSwitchStatsResponse
	31, // 87: lemming.dataplane.sai.Switch.CreateSwitchTunnel:output_type -> lemming.dataplane.sai.CreateSwitchTunnelResponse
	33, // 88: lemming.dataplane.sai.Switch.RemoveSwitchTunnel:output_type -> lemming.dataplane.sai.RemoveSwitchTunnelResponse
	35, // 89: lemming.dataplane.sai.Switch.SetSwitchTunnelAttribute:output_type -> lemming.dataplane.sai.SetSwitchTunnelAttributeResponse
	37, // 90: lemming.dataplane.sai.Switch.GetSwitchTunnelAttribute:output_type -> lemming.dataplane.sai.GetSwitchTunnelAttributeResponse
...
func file_dataplane_proto_sai_switch_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dataplane_proto_sai_switch_proto_rawDesc), len(file_dataplane_proto_sai_switch_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   36,
			NumExtensions: 0,
			NumServices:   1,
