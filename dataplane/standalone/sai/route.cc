  ...
  for (uint32_t i = 0; i < attr_count; i++) {
    switch (attr_list[i].id) {
      ...
      case SAI_ROUTE_ENTRY_ATTR_COUNTER_ID:
        ...
        break;
      case SAI_ROUTE_ENTRY_ATTR_PREFIX_AGG_ID:
        msg.set_prefix_agg_id(attr_list[i].value.u32);
        break;
    }
  }
  return msg;
  ...
  *req.mutable_entry() = convert_from_route_entry(*route_entry);
  ...
  switch (attr->id) {
    ...
    case SAI_ROUTE_ENTRY_ATTR_COUNTER_ID:
      ...
      break;
    case SAI_ROUTE_ENTRY_ATTR_PREFIX_AGG_ID:
      req.set_prefix_agg_id(attr->value.u32);
      break;
  }
  ...
  for (uint32_t i = 0; i < attr_count; i++) {
    switch (attr_list[i].id) {
      ...
      case SAI_ROUTE_ENTRY_ATTR_COUNTER_ID:
        ...
        break;
      case SAI_ROUTE_ENTRY_ATTR_PREFIX_AGG_ID:
        attr_list[i].value.u32 = resp.attr().prefix_agg_id();
        break;
    }
  }
