  ...
  for (uint32_t i = 0; i < attr_count; i++) {
    switch (attr_list[i].id) {
      ...
      case SAI_SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE:
        msg.set_hostif_oper_status_update_mode(
      ...
      case SAI_SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        msg.mutable_reg_fatal_switch_asic_sdk_health_category()->CopyFrom(
      ...
      case SAI_SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        msg.mutable_reg_warning_switch_asic_sdk_health_category()->CopyFrom(
            convert_list_sai_switch_asic_sdk_health_category_t_to_proto(
                attr_list[i].value.s32list));
        break;
      case SAI_SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        msg.mutable_reg_notice_switch_asic_sdk_health_category()->CopyFrom(
            convert_list_sai_switch_asic_sdk_health_category_t_to_proto(
                attr_list[i].value.s32list));
        break;
      case SAI_SWITCH_ATTR_POE_DEVICE_LIST:
        msg.mutable_poe_device_list()->Add(
            attr_list[i].value.objlist.list,
            attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
        break;
      case SAI_SWITCH_ATTR_STATS_COUNT_MODE:
...
sai_status_t l_set_switch_attribute(sai_object_id_t switch_id,
  ...
  switch (attr->id) {
    ...
    case SAI_SWITCH_ATTR_SWITCH_ISOLATE:
      ...
      break;
    case SAI_SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE:
      req.set_hostif_oper_status_update_mode(
          convert_sai_switch_hostif_oper_status_update_mode_t_to_proto(
              attr->value.s32));
      break;
    case SAI_SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
      req.mutable_reg_fatal_switch_asic_sdk_health_category()->CopyFrom(
          convert_list_sai_switch_asic_sdk_health_category_t_to_proto(
              attr->value.s32list));
      break;
    case SAI_SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
      req.mutable_reg_warning_switch_asic_sdk_health_category()->CopyFrom(
          convert_list_sai_switch_asic_sdk_health_category_t_to_proto(
              attr->value.s32list));
      break;
    case SAI_SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
      req.mutable_reg_notice_switch_asic_sdk_health_category()->CopyFrom(
          convert_list_sai_switch_asic_sdk_health_category_t_to_proto(
              attr->value.s32list));
      break;
    case SAI_SWITCH_ATTR_POE_DEVICE_LIST:
      req.mutable_poe_device_list()->Add(
          attr->value.objlist.list,
          attr->value.objlist.list + attr->value.objlist.count);
      break;
    case SAI_SWITCH_ATTR_STATS_COUNT_MODE:
  ...
  for (uint32_t i = 0; i < attr_count; i++) {
    switch (attr_list[i].id) {
      ...
      case SAI_SWITCH_ATTR_ACL_STAGE_POST_INGRESS:
        convert_to_acl_capability(attr_list[i].value.aclcapability,
                                  resp.attr().acl_stage_post_ingress());
        break;
      case SAI_SWITCH_ATTR_CREDIT_WD:
      ...
      case SAI_SWITCH_ATTR_HOSTIF_OPER_STATUS_UPDATE_MODE:
        attr_list[i].value.s32 =
            convert_sai_switch_hostif_oper_status_update_mode_t_to_sai(
                resp.attr().hostif_oper_status_update_mode());
        break;
      case SAI_SWITCH_ATTR_REG_FATAL_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        convert_list_sai_switch_asic_sdk_health_category_t_to_sai(
            attr_list[i].value.s32list.list,
            resp.attr().reg_fatal_switch_asic_sdk_health_category(),
            &attr_list[i].value.s32list.count);
        break;
      case SAI_SWITCH_ATTR_REG_WARNING_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        convert_list_sai_switch_asic_sdk_health_category_t_to_sai(
            attr_list[i].value.s32list.list,
            resp.attr().reg_warning_switch_asic_sdk_health_category(),
            &attr_list[i].value.s32list.count);
        break;
      case SAI_SWITCH_ATTR_REG_NOTICE_SWITCH_ASIC_SDK_HEALTH_CATEGORY:
        convert_list_sai_switch_asic_sdk_health_category_t_to_sai(
            attr_list[i].value.s32list.list,
            resp.attr().reg_notice_switch_asic_sdk_health_category(),
            &attr_list[i].value.s32list.count);
        break;
      case SAI_SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MINIMUM_PRIORITY:
        attr_list[i].value.u32 =
            resp.attr().tunnel_term_table_entry_minimum_priority();
        break;
      case SAI_SWITCH_ATTR_TUNNEL_TERM_TABLE_ENTRY_MAXIMUM_PRIORITY:
        attr_list[i].value.u32 =
            resp.attr().tunnel_term_table_entry_maximum_priority();
        break;
      ...
      case SAI_SWITCH_ATTR_AVAILABLE_IP_NEXT_HOP_GROUP_MEMBER_ENTRY:
        attr_list[i].value.u32 =
            resp.attr().available_ip_next_hop_group_member_entry();
        break;
      ...
      case SAI_SWITCH_ATTR_ACL_STAGE_PRE_INGRESS:
        convert_to_acl_capability(attr_list[i].value.aclcapability,
                                  resp.attr().acl_stage_pre_ingress());
        break;
      case SAI_SWITCH_ATTR_POE_DEVICE_LIST:
        copy_list(attr_list[i].value.objlist.list,
                  resp.attr().poe_device_list(),
                  &attr_list[i].value.objlist.count);
        break;
      case SAI_SWITCH_ATTR_AVAILABLE_ICMP_ECHO_SESSION:
        attr_list[i].value.u32 = resp.attr().available_icmp_echo_session();
        break;
      case SAI_SWITCH_ATTR_MAX_ICMP_ECHO_SESSION:
        attr_list[i].value.u32 = resp.attr().max_icmp_echo_session();
        break;
      case SAI_SWITCH_ATTR_STATS_COUNT_MODE:
